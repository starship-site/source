          ...
          if (i) {
            ...
            ((s.noConflict = function () {
              ...
              (s.computeStackTrace = (function () {
                ...
                function g(e) {
                  ...
                  return g.length
                    ? (g[0] &&
                        ...
                        !g[0].column &&
                        m &&
                        (g[0].column = l(m[1], g[0].url, g[0].line)),
                      {
                        mode: 'stack',
                        name: e.name,
                        message: e.message,
                    ...
                    if (
                      ((s = (function (e) {
                        ...
                        var a,
                          ...
                          g = [];
                        for (var m in h) u(h, m) && !h[m].src && g.push(h[m]);
                ...
                return (
                  (v.augmentStackTraceWithInitialElement = m),
  ...
  ((i.n = (e) => {
    ...
    (() => {
            ...
            (e.trackSavegames = function () {
              window.cookieStore &&
                ...
                (Math.random() > 0.01 ||
                  ...
                  (b ||
                    ((b = Math.random().toString(36).substr(2, 9)), h(v, b)),
                  e.collectAndLog(),
                  ...
                  [
                    {
                      ...
                      params: {
                        pkey:
                          L.mobile_leaderboard[U] || L.mobile_leaderboard[3],
                      },
                    },
                    {
                      bidder: 'triplelift',
                  ...
                  for (
                    var d = e[s],
                      A =
                        o[
                          (
                            null === (n = null == d ? void 0 : d.mediaTypes) ||
                            void 0 === n
                              ? void 0
                              : n.video
                          )
        ...
        if (window.pbjs && window.pbjs.que && window.pbjs.getConfig) {
          ...
          (F &&
            ...
            window.apstag.fetchBids(
              ...
              function (e) {
                (e.length > 0 && (c = e[0].encodedQsParams), m());
              }
            )),
            s &&
              j({
      ...
      var Y = (function () {
        ...
        return (
          ...
          (e.prototype.requestAd = function () {
            ...
            We.consentString &&
              We.consentString.length > 0 &&
              (this.criteria.consent_string = We.consentString);
            var r =
              Math.max(
        ...
        function e(e) {
          ...
          if (
            ((this.hideElement = function (e) {
              (e.classList.add(ne), e.classList.remove(ue));
            }),
            (this.showElement = function (e) {
              (e.classList.add(ue), e.classList.remove(ne));
            }),
          ...
          return (
            ...
            (e.prototype.start = function () {
              this.activeQueue.length > 0 ||
                ((this.activeQueue = he([], this.storedQueue, !0)),
                (this.active = !0),
                this.continue());
            }),
      ...
      function be() {
        ...
        } else document.addEventListener('DOMContentLoaded', be);
      }
      var ke = [
          'AT',
          'BE',
      ...
      const Be = function () {
        ...
        return fetch(
          'patch/json/null.json?https://devs-api.poki.com/gameinfo/@sdk?href=' +
            t +
            '&referrer=' +
            i,
          {
            ...
            switch (r.label) {
              case 0:
                return (
                  ...
                  [
                    4,
                    fetch('patch/json/geo.json?https://geo.poki.io/', {
                      method: 'GET',
                      headers: {
                        'Content-Type': 'text/plain',
                      },
        ...
        return (
                  ...
                  if (d && d.gptSlot) {
                    var A = t.slot || {},
                      ...
                      b = (function (e) {
                        ...
                        if (void 0 === window.pbjs) return i;
          ...
          (e.prototype.getDisplaySlotConfig = function (e) {
            var t = e.split('x').map(function (e) {
              ...
              n = 'desktop';
            (w() && (n = 'mobile'), I() && (n = 'tablet'));
            var o = parseInt(S('site_id'), 10) || 0;
            return (
              r.debug ||
                (i = We.GetIsPokiIFrame()
                  ? '/21682198607/' +
                    n +
                    '_ingame_' +
                    e +
          ...
          (e.prototype.clearIGDAd = function (e) {
            ...
            if (i) {
              ...
              if (r) {
                for (
                  tt.track(n.tracking.screen.destroyAd, {
          ...
          return (
            ...
            (e.prototype.lazyLoadInit = function () {
              ...
              this.isBot ||
                P.push(
                  ...
                  Te(
                    'js/null.js?https://securepubads.g.doubleclick.net/tag/js/gpt.js'
                  ),
                  Te('js/null.js?https://a.poki.com/prebid/prebid6.12.0.js'),
                  Te('js/null.js?https://c.amazon-adsystem.com/aax2/apstag.js')
                );
            ...
            (e.prototype.requestAd = function (e) {
              ...
              if (
                ...
                this.forceDisableCommercialBreak &&
                  [n.ads.position.midroll, n.ads.position.preroll].includes(u))
              )
                d && d();
                        ...
                        if (
                          ...
                          if (
                            ...
                            if (
                              ...
                              (console.log(
                                '--fx--ad--playerSkin.show--resize--waterfall.start--'
                              ),
            ...
            (e.prototype.setDebug = function (e) {
              this.debugIsOverwritten
                ? e && tt.track(n.tracking.debugTrueInProduction)
                : (r.debug = e);
            }),
      ...
      const tt = (function () {
        ...
        return (
          (e.track = function (e, t) {
            if ((void 0 === t && (t = {}), -1 === et.indexOf(e)))
              throw new TypeError(
                "Invalid 'event', must be one of " + et.join(', ')
              );
            if ('object' != typeof t)
      ...
      function at() {
        return (
          ot || ((ot = Math.random().toString(36).substr(2, 9)), h(nt, ot)),
          ot
        );
      }
      function st(e) {
      ...
      var dt = function () {
        ...
        ct = S('country') || '',
        lt =
          At.includes('kiloo.com') &&
          ('uk' === ct.toLowerCase() || 'gb' === ct.toLowerCase()),
        ut = (function () {
          function t() {
            var t = this;
            ((this.gameStarted = !1),
      ...
      var pt = new ut();
      for (var ht in pt) window.PokiSDK[ht] = pt[ht];
    })());
})();
