      ...
      var s = function (t) {
        ...
        c = (function (t) {
          function e(t, r) {
            ...
            ((a.initFrames = a.initFrames.bind(a)),
              (a.getUsableBounds = a.getUsableBounds.bind(a)),
              (a.drawFrames = a.drawFrames.bind(a)),
              (a.resize = a.resize.bind(a)),
              (a.updateSafeBounds = a.updateSafeBounds.bind(a)),
              (a.enableDebugDraw = a.enableDebugDraw.bind(a)),
              (a.events = new o.default.Events.EventEmitter()),
              (a.sliceConfig = s(r)),
              (a._safeBounds = new o.default.Geom.Rectangle()));
            var u = a.sliceConfig,
              l = u.sourceKey,
              c = u.sourceFrame;
            if (
              ((a.sourceTex = t.sys.textures.get(a.sliceConfig.sourceKey)), !l)
            )
              throw new Error(
                'NineSlice requires a texture sourceKey to be specified.'
              );
            if (!a.sourceTex || a.sourceTex.key === f)
              throw new Error('Expected source image ' + l + ' not found.');
            ((a._framePrefix =
              '' +
              (0, n.default)(
                JSON.stringify({ sourceKey: l, sourceFrame: c }, 404)
              )),
              (a.mkFrameName = function (t) {
                return a._framePrefix + '-' + t;
              }),
              (a._frameCache = {}));
            var d = 'string' == typeof c || 'number' == typeof c ? c : h;
            ((a.sourceFrame = a.sourceTex.get(d)),
              a.initFrames(),
              (a._initalized = !0));
            var y = i.x,
              b = i.y,
              ...
              p = i.height;
            return (
              a.setPosition(y || 0, b || 0),
              a.resize(g || a.sourceFrame.width, p || a.sourceFrame.height),
              a.updateSafeBounds(),
              a
            );
          }
              ...
              ((t.prototype = Object.create(e && e.prototype, {
                ...
                e &&
                  (Object.setPrototypeOf
                    ...
                    : (t.__proto__ = e)));
            })(e, o.default.GameObjects.RenderTexture),
            i(e, [
              {
              ...
              },
              {
                ...
                value: function () {
                  var t = this,
                    ...
                    s = u(this.sliceConfig.sourceLayout);
                  ...
                  var h = Math.min(s.tl.x, s.bl.x),
                    f = Math.min(s.tl.y, s.tr.y);
                  a(
                    'center',
                    h,
                    f,
                    r - h - Math.min(s.tr.x, s.br.x),
                    i - f - Math.min(s.br.y, s.bl.y)
                  );
                },
              },
              {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (this._initalized) {
                    ...
                    var e = u(this.sliceConfig.sourceLayout),
                      r = this._frameCache,
            ...
            ((t.prototype = Object.create(e && e.prototype, {
              ...
              e &&
                (Object.setPrototypeOf
                  ? Object.setPrototypeOf(t, e)
                  : (t.__proto__ = e)));
          })(e, a.default.Plugins.BasePlugin),
          n(e, [
            {
              key: 'addNineSlice',
              value: function () {
          ...
          if (e.length > 6)
            if ('number' == typeof e[6]) {
              ...
              var O = (0, u.default)(e[6]),
                ...
                P = M[2],
                L = M[3];
              d.safeOffsets = { top: j, right: E, bottom: P, left: L };
            }
