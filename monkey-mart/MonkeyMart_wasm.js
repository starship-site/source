...
function _PokiSdkJs_RewardedBreak(callback, category, details, placement) {
  ...
  PokiSDK.rewardedBreak(
    ...
    UTF8ToString(details),
    UTF8ToString(placement)
  ).then(PokiSdk._rewardedBreakCallback);
}
...
function _PokiSdkJs_ShareableURL(callback) {
  ...
  PokiSDK.shareableURL(PokiSdk._urlParameters).then(
    PokiSdk._shareableURLCallback
  );
  ...
  refreshJoysticks: function (forceUpdate) {
    if (
      ...
      for (var joy = 0; joy < GLFW.lastGamepadState.length; ++joy) {
        ...
        if (gamepad) {
          var gamepad_id =
            gamepad.mapping == 'standard' ? 'Standard Gamepad' : gamepad.id;
...
var asmLibraryArg = {
  Bi: _PokiSdkJs_AddParameterForURL,
  Ai: _PokiSdkJs_CaptureError,
  zi: _PokiSdkJs_CommercialBreak,
  yi: _PokiSdkJs_GameplayStart,
  xi: _PokiSdkJs_GameplayStop,
  wi: _PokiSdkJs_GetURLParam,
  vi: _PokiSdkJs_InternalCaptureError,
  ui: _PokiSdkJs_IsAdBlocked,
  ti: _PokiSdkJs_RewardedBreak,
  si: _PokiSdkJs_SetDebug,
  ri: _PokiSdkJs_ShareableURL,
  b: ___assert_fail,
  qi: ___clock_gettime,
  pi: ___gmtime_r,
  oi: ___localtime_r,
  mi: ___sys__newselect,
  di: ___sys_dup2,
  ii: ___sys_dup3,
  j: ___sys_fcntl64,
  ei: ___sys_ioctl,
  ...
  ai: _clock,
  $h: _difftime,
  _h: _dmDeviceJSFreeBufferSlots,
  Zh: _dmDeviceJSOpen,
  Yh: _dmDeviceJSQueue,
  Xh: _dmGetDeviceSampleRate,
  Wh: _dmResZipRequestFileAsync,
  ...
  zh: _emscripten_glBindVertexArrayOES,
  yh: _emscripten_glBlendColor,
  xh: _emscripten_glBlendEquation,
  wh: _emscripten_glBlendEquationSeparate,
  vh: _emscripten_glBlendFunc,
  uh: _emscripten_glBlendFuncSeparate,
  th: _emscripten_glBlitFramebuffer,
  sh: _emscripten_glBufferData,
  rh: _emscripten_glBufferSubData,
  qh: _emscripten_glCheckFramebufferStatus,
  ph: _emscripten_glClear,
  oh: _emscripten_glClearBufferfi,
  nh: _emscripten_glClearBufferfv,
  mh: _emscripten_glClearBufferiv,
  lh: _emscripten_glClearBufferuiv,
  kh: _emscripten_glClearColor,
  jh: _emscripten_glClearDepthf,
  ih: _emscripten_glClearStencil,
  hh: _emscripten_glClientWaitSync,
  gh: _emscripten_glColorMask,
  fh: _emscripten_glCompileShader,
  eh: _emscripten_glCompressedTexImage2D,
  dh: _emscripten_glCompressedTexImage3D,
  ch: _emscripten_glCompressedTexSubImage2D,
  bh: _emscripten_glCompressedTexSubImage3D,
  ah: _emscripten_glCopyBufferSubData,
  $g: _emscripten_glCopyTexImage2D,
  _g: _emscripten_glCopyTexSubImage2D,
  ...
  zg: _emscripten_glDrawArraysInstancedARB,
  yg: _emscripten_glDrawArraysInstancedEXT,
  xg: _emscripten_glDrawArraysInstancedNV,
  wg: _emscripten_glDrawBuffers,
  vg: _emscripten_glDrawBuffersEXT,
  ug: _emscripten_glDrawBuffersWEBGL,
  tg: _emscripten_glDrawElements,
  sg: _emscripten_glDrawElementsInstanced,
  rg: _emscripten_glDrawElementsInstancedANGLE,
  qg: _emscripten_glDrawElementsInstancedARB,
  pg: _emscripten_glDrawElementsInstancedEXT,
  og: _emscripten_glDrawElementsInstancedNV,
  ng: _emscripten_glDrawRangeElements,
  mg: _emscripten_glEnable,
  lg: _emscripten_glEnableVertexAttribArray,
  kg: _emscripten_glEndQuery,
  jg: _emscripten_glEndQueryEXT,
  ig: _emscripten_glEndTransformFeedback,
  hg: _emscripten_glFenceSync,
  gg: _emscripten_glFinish,
  fg: _emscripten_glFlush,
  eg: _emscripten_glFramebufferRenderbuffer,
  dg: _emscripten_glFramebufferTexture2D,
  cg: _emscripten_glFramebufferTextureLayer,
  bg: _emscripten_glFrontFace,
  ag: _emscripten_glGenBuffers,
  $f: _emscripten_glGenFramebuffers,
  _f: _emscripten_glGenQueries,
  ...
  If: _emscripten_glGetBufferParameteriv,
  Hf: _emscripten_glGetError,
  Gf: _emscripten_glGetFloatv,
  Ff: _emscripten_glGetFragDataLocation,
  Ef: _emscripten_glGetFramebufferAttachmentParameteriv,
  Df: _emscripten_glGetInteger64i_v,
  Cf: _emscripten_glGetInteger64v,
  Bf: _emscripten_glGetIntegeri_v,
  Af: _emscripten_glGetIntegerv,
  ...
  hf: _emscripten_glGetShaderiv,
  gf: _emscripten_glGetString,
  ff: _emscripten_glGetStringi,
  ef: _emscripten_glGetSynciv,
  df: _emscripten_glGetTexParameterfv,
  cf: _emscripten_glGetTexParameteriv,
  bf: _emscripten_glGetTransformFeedbackVarying,
  af: _emscripten_glGetUniformBlockIndex,
  $e: _emscripten_glGetUniformIndices,
  _e: _emscripten_glGetUniformLocation,
  ...
  $d: _emscripten_glStencilOpSeparate,
  _d: _emscripten_glTexImage2D,
  ...
  $c: _emscripten_glVertexAttrib4f,
  _c: _emscripten_glVertexAttrib4fv,
  ...
  Ac: _glColorMask,
  P: _glCompileShader,
  r: _glCompressedTexImage2D,
  zc: _glCompressedTexImage3D,
  q: _glCompressedTexSubImage2D,
  yc: _glCompressedTexSubImage3D,
  va: _glCreateProgram,
  Y: _glCreateShader,
  xc: _glCullFace,
  ua: _glDeleteBuffers,
  wc: _glDeleteFramebuffers,
  O: _glDeleteProgram,
  p: _glDeleteRenderbuffers,
  N: _glDeleteShader,
  vc: _glDeleteTextures,
  uc: _glDepthFunc,
  tc: _glDepthMask,
  sc: _glDisable,
  rc: _glDisableVertexAttribArray,
  qc: _glDrawArrays,
  pc: _glDrawBuffers,
  oc: _glDrawElements,
  nc: _glEnable,
  ...
  mc: _glFlush,
  lc: _glFramebufferRenderbuffer,
  kc: _glFramebufferTexture2D,
  jc: _glFrontFace,
  sa: _glGenBuffers,
  ic: _glGenFramebuffers,
  E: _glGenRenderbuffers,
  hc: _glGenTextures,
  gc: _glGetActiveAttrib,
  fc: _glGetActiveUniform,
  ec: _glGetAttribLocation,
  c: _glGetError,
  dc: _glGetFloatv,
  D: _glGetIntegerv,
  ...
  L: _glShaderSource,
  _b: _glStencilFunc,
  Zb: _glStencilFuncSeparate,
  Yb: _glStencilMask,
  Xb: _glStencilOp,
  Wb: _glStencilOpSeparate,
  m: _glTexImage2D,
  Vb: _glTexImage3D,
  Ub: _glTexParameterf,
  K: _glTexParameteri,
  ...
  Pb: _glViewport,
  Ob: _glfwAccelerometerEnable,
  Nb: _glfwCloseWindow,
  Mb: _glfwDisable,
  Lb: _glfwEnable,
  Kb: _glfwGetAcceleration,
  ma: _glfwGetDefaultFramebuffer,
  Jb: _glfwGetDisplayScaleFactor,
  ...
  Db: _glfwGetMouseLocked,
  Cb: _glfwGetMousePos,
  Bb: _glfwGetMouseWheel,
  V: _glfwGetProcAddress,
  ...
  xb: _glfwInitJS,
  wb: _glfwOpenWindow,
  U: _glfwOpenWindowHint,
  vb: _glfwPollEvents,
  ub: _glfwResetKeyboard,
  tb: _glfwSetCharCallback,
  sb: _glfwSetDeviceChangedCallback,
  rb: _glfwSetGamepadCallback,
  qb: _glfwSetMarkedTextCallback,
  pb: _glfwSetTouchCallback,
  ob: _glfwSetWindowBackgroundColor,
  nb: _glfwSetWindowCloseCallback,
  mb: _glfwSetWindowFocusCallback,
  lb: _glfwSetWindowIconifyCallback,
  ...
  h: invoke_viiii,
  u: invoke_viiiii,
  gb: _js_addBusinessEvent,
  fb: _js_addDesignEvent,
  eb: _js_addDesignEventWithValue,
  db: _js_addErrorEvent,
  cb: _js_addProgressionEvent,
  bb: _js_addProgressionEventWithScore,
  ab: _js_addResourceEvent,
  $a: _js_configureAvailableCustomDimensions01,
  _a: _js_configureAvailableCustomDimensions02,
  Za: _js_configureAvailableCustomDimensions03,
  Ya: _js_configureAvailableResourceCurrencies,
  Xa: _js_configureAvailableResourceItemTypes,
  Wa: _js_configureBuild,
  Va: _js_configureGameEngineVersion,
  Ua: _js_configureSdkGameEngineVersion,
  Ta: _js_configureUserId,
  Sa: _js_endSession,
  Ra: _js_getRemoteConfigsContentAsString,
  Qa: _js_getRemoteConfigsValueAsStringWithDefaultValue,
  Pa: _js_initialize,
  Oa: _js_isRemoteConfigsReady,
  Na: _js_setCustomDimension01,
  Ma: _js_setCustomDimension02,
  La: _js_setCustomDimension03,
  ga: _js_setEnabledInfoLog,
  fa: _js_setEnabledVerboseLog,
  ea: _js_setEventSubmission,
  Ka: _js_setGlobalCustomEventFields,
...
var _main = (Module['_main'] = function () {
  return (_main = Module['_main'] = Module['asm']['Fi']).apply(null, arguments);
});
...
var _free = (Module['_free'] = function () {
  return (_free = Module['_free'] = Module['asm']['Hi']).apply(null, arguments);
});
...
var _htonl = (Module['_htonl'] = function () {
  return (_htonl = Module['_htonl'] = Module['asm']['Ji']).apply(
    null,
    arguments
  );
});
...
var _JSWriteDump = (Module['_JSWriteDump'] = function () {
  return (_JSWriteDump = Module['_JSWriteDump'] = Module['asm']['Pi']).apply(
    null,
    arguments
  );
});
var __get_tzname = (Module['__get_tzname'] = function () {
  return (__get_tzname = Module['__get_tzname'] = Module['asm']['Qi']).apply(
    null,
    arguments
  );
});
...
var stackSave = (Module['stackSave'] = function () {
  return (stackSave = Module['stackSave'] = Module['asm']['Ti']).apply(
    null,
    arguments
  );
});
var stackRestore = (Module['stackRestore'] = function () {
  return (stackRestore = Module['stackRestore'] = Module['asm']['Ui']).apply(
    null,
    arguments
  );
});
var stackAlloc = (Module['stackAlloc'] = function () {
  return (stackAlloc = Module['stackAlloc'] = Module['asm']['Vi']).apply(
    null,
    arguments
  );
});
var _setThrew = (Module['_setThrew'] = function () {
  return (_setThrew = Module['_setThrew'] = Module['asm']['Wi']).apply(
    null,
    arguments
  );
});
var dynCall_jii = (Module['dynCall_jii'] = function () {
  return (dynCall_jii = Module['dynCall_jii'] = Module['asm']['Xi']).apply(
    null,
    arguments
  );
});
