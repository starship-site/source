      ...
      !(function (e) {
        ...
        var n =
          ...
          (f.validateArrayOfStrings = function (e, n, t, i, r) {
            ...
            if (((s = s || 'Array'), !r))
              return (
                d.w(s + ' validation failed: array cannot be null. '),
                !1
              );
            if (0 == t && 0 == r.length)
              return (
                d.w(s + ' validation failed: array cannot be empty. '),
                !1
              );
            if (0 < e && r.length > e)
              return (
        ...
        var s =
          ...
          (v.getStore = function (e) {
            switch (e) {
              ...
              default:
                return (
                  r.w('GAStore.getStore(): Cannot find store: ' + e),
                  null
                );
            }
          }),
        ...
        (l.execute = function (e, n, t, i) {
          ...
          if (
            ...
            ((a.onreadystatechange = function () {
              ...
              a.open('GET', 'patch/json/null.json?' + e, !0),
        ...
        (y.initRequestCallback = function (e, n, t, i) {
          ...
          if (
            ...
            if (o !== u.EGAHTTPApiResponse.BadRequest) {
              var d = h.validateAndCleanInitRequestResponse(
                a,
                o === u.EGAHTTPApiResponse.Created
              );
              d
          ...
          if (S.isEventSubmissionEnabled())
            try {
              ...
              for (var d = [], l = 0; l < a.length; ++l) {
                ...
                if (0 != c.length) {
                  var v = c.client_ts;
                  (v && !b.validateClientTs(v) && delete c.client_ts,
                    d.push(c));
                }
              }
    ...
    (function (e) {
      ...
      ((r = e.threading || (e.threading = {})),
        ...
        (a.performTimedBlockOnGAThread = function (e) {
          ((a.instance.id2TimedBlockMap[e.id] = e),
            a.instance.addTimedBlock(e));
        }),
      ...
      var l = d.threading.GAThreading,
        ...
        n =
          ...
          (E.getRemoteConfigsValueAsString = function (e, n) {
            return (
              void 0 === n && (n = null),
              c.getConfigurationStringValue(e, n)
            );
          }),
