...
function insertBacklinks() {
  ...
  let backlinksHTML = '';
  backlinksHTML =
    '<ul style="color: #ffffff; padding: 0px; margin: 0px; font-size:18px;">';
  backlinksHTML +=
    '<li style="padding: 10px; display: inline-block; float: left;">' +
    '<a style="padding: 5px;color: #ffffff; text-decoration: none; " onMouseOver="this.style.backgroundColor=\'#0C1E40\';" onMouseOut="this.style.backgroundColor=\'\';" href= "//slopegame.gitlab.io">' +
  ...
  backlinksHTML +=
    ...
    '<a onclick= "return closeBacklinks();" style="padding: 5px;color: #ffffff; text-decoration: none;" onMouseOver="this.style.backgroundColor=\'#ff6666\';" onMouseOut="this.style.backgroundColor=\'\';" href="#">' +
  ...
  backlinksPlace.style.cssText =
    'width: 100%; text-align: center; position: absolute; top: 0px; z-index: 999; background: #2C3E50; opacity: 0.9;';
