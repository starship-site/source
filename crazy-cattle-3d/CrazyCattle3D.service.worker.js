...
const CACHED_FILES = [
  'CrazyCattle3D.html',
  'CrazyCattle3D.js',
  'CrazyCattle3D.offline.html',
  'CrazyCattle3D.icon.png',
  'CrazyCattle3D.apple-touch-icon.png',
  'CrazyCattle3D.audio.worklet.js',
  'CrazyCattle3D.audio.position.worklet.js',
];
