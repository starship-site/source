...
*/
  ...
  var ya = function (a, b, c) {
    ...
    Da = function (a, b, c, d) {
      try {
        ...
        return ((a.g.o = null), xa(a.g, g), Ea(a));
      }
      a.g.o = null;
      d.call(a.g, f);
      return Ea(a);
    ...
    Ga = function (a) {
      this.next = function (b) {
        wa(a.g);
        a.g.o ? (b = Da(a, a.g.o.next, b, a.g.B)) : (a.g.B(b), (b = Ea(a)));
        return b;
      };
      this.throw = function (b) {
        wa(a.g);
        a.g.o
          ? (b = Da(a, a.g.o['throw'], b, a.g.B))
          : (xa(a.g, b), (b = Ea(a)));
        return b;
      };
  ...
  function Bb() {
    return wb()
      ? vb('Chromium')
      : ((x('Chrome') || x('CriOS')) && !(wb() ? 0 : x('Edge'))) || x('Silk');
  }
  function Cb() {
      ...
      function c(k) {
        for (; d < a.length; ) {
          var m = a.charAt(d++),
            n = Dc[m];
          if (null != n) return n;
          if (!ib(m)) throw Error('Unknown base64 encoding at char: ' + m);
        }
        return k;
      }
      Ec();
  ...
  function Oc(a) {
    ...
    b &&
      ((c = q(Pc(c, a))), (b = c.next().value), (a = c.next().value), (c = b));
    Mc = c >>> 0;
    Nc = a >>> 0;
  }
  var Qc = 'function' === typeof BigInt;
  function Rc(a) {
    if (16 > a.length) Oc(Number(a));
    else if (Qc)
      ((a = BigInt(a)),
      ...
      for (
        ...
        ((d = Number(a.slice(d, e))),
          ...
          (Mc = 1e6 * Mc + d),
          4294967296 <= Mc &&
            ((Nc += (Mc / 4294967296) | 0), (Mc %= 4294967296)));
      b &&
        ((b = q(Pc(Mc, Nc))),
        (a = b.next().value),
        (b = b.next().value),
  ...
  function kd(a) {
    var b = z(a);
    1 !== (b & 1) &&
      (Object.isFrozen(a) && (a = Array.prototype.slice.call(a)), ld(a, b | 1));
  }
  function od(a, b) {
  ...
  var C = function (a, b, c) {
    ...
    Hd = function (a, b, c, d) {
      a.l && (a.l = void 0);
      if (b >= a.j || d)
        return ((d = a.j + a.h), ((a.g || (a.g = a.ba[d] = {}))[b] = c), a);
      a.ba[b + a.h] = c;
  ...
  function Ld(a, b, c) {
    var d = !!(z(a.ba) & 2),
      ...
      f = z(e);
    if (!(f & 4)) {
      Object.isFrozen(e) && ((e = qd(e.slice())), Hd(a, b, e));
    ...
    !d &&
      ...
      ((e = Array.prototype.slice.call(e)), jd(e, 5), Hd(a, b, e));
    return e;
  }
  function Md(a, b, c, d) {
    if (null == c) return Id(a, b);
    var e = z(c);
    if (!(e & 4)) {
  ...
  var Od = function (a, b) {
      for (var c = 0, d = 0; d < b.length; d++) {
        var e = b[d];
        null != C(a, e) && (0 !== c && Hd(a, c, void 0, !1), (c = e));
      }
      return c;
    },
    Pd = function (a, b, c, d) {
  ...
  function Sd(a, b, c, d, e) {
    ...
    f ||
      ...
      1 === d
        ...
        : ((d = z(g)),
          (b = d & -19),
          f && ((g = Array.prototype.slice.call(g)), (d = 0), Hd(a, c, g)),
          d !== b && ld(g, b)));
    return g;
  }
  ...
  function ge(a, b) {
    for (
      var c = Array.prototype.slice.call(a.ba),
        d = a.g,
        e = c.length + (d ? -1 : 0),
        f = 0;
      f < e;
      ...
      if (Array.isArray(a))
        a =
          e && 0 == a.length && z(a) & 1
            ...
            : f && z(a) & 2
              ? a
              : ie(a, b, c, void 0 !== d, e, f);
      else if (vd(a)) {
        var g = {},
          h;
        for (h in a) g[h] = he(a[h], b, c, d, e, f);
        a = g;
      } else a = b(a, d);
      return a;
    }
  ...
  function ie(a, b, c, d, e, f) {
    ...
    for (var h = 0; h < a.length; h++) a[h] = he(a[h], b, c, d, e, f);
    c && c(g, a);
    return a;
  }
  function je(a) {
  ...
  function ke(a, b, c) {
    ...
    if (null != a) {
      ...
      if (Array.isArray(a)) {
        var d = z(a);
        if (d & 2) return a;
        if (b && !(d & 32) && (d & 16 || 0 === d)) return (ld(a, d | 18), a);
        a = ie(a, ke, d & 4 ? td : c, !0, !1, !0);
        b = z(a);
        b & 4 && b & 2 && Object.freeze(a);
        return a;
      }
      a.Wc === ud && (z(a.ba) & 2 || ((a = le(a, !0)), jd(a.ba, 18)));
      return a;
    }
  }
  function le(a, b) {
  ...
  var D = function (a, b, c) {
    ...
    a: {
      c = this.ba.length;
      a = c - 1;
      if (c && ((c = this.ba[a]), vd(c))) {
        this.g = c;
        this.j = a - this.h;
        break a;
      }
      b
        ? ((this.j = Math.max(b, a + 1 - this.h)), (this.g = void 0))
        : (this.j = Number.MAX_VALUE);
    }
  };
  D.prototype.toJSON = function () {
    if (wd) var a = me(this, this.ba, !1);
    else ((a = ie(this.ba, je, void 0, void 0, !1, !1)), (a = me(this, a, !0)));
    return a;
  };
  var ne = function (a) {
    wd = !0;
  ...
  function oe(a, b) {
    ...
    return Array.isArray(c) &&
      (pe in c || qe in c || (0 < c.length && 'function' == typeof c[0]))
      ? c
      : void 0;
  }
  var re = Symbol();
      ...
      for (; e < a.length; ) {
        ...
        switch (g) {
          case 0:
            ...
            break;
          case 1:
            (g = oe(a, e)) ? (e++, (b[f] = d(h, g))) : (b[f] = c(h, a[e++]));
            break;
          case 2:
            g = b;
            var k = e++;
  ...
  function ue(a, b, c) {
    for (var d = a.ba, e = a.h, f = d.length, g = 0 === e ? 1 : 0; g < f; g++) {
      ...
      if (null != h)
        ...
        else ((h = g - e), (m = xe(c, h)) && m(b, a, h));
    }
    if ((a = a.o))
      for (dd(b, b.g.end()), c = 0; c < a.length; c++)
  ...
  function ze(a, b, c) {
    b = C(b, c);
    null != b &&
      ('string' === typeof b && Xc(b),
      null != b &&
        (ed(a, c, 0),
        'number' === typeof b
          ? ((a = a.g), Oc(b), Zc(a, Mc, Nc))
          : ((c = Xc(b)), Zc(a.g, c.h, c.g))));
  }
  function Ae(a, b, c) {
    b = Ad(C(b, c));
    null != b && null != b && (ed(a, c, 0), ad(a.g, b));
  }
  var Be = ye(function (a, b, c) {
      ...
      if (null != b) {
        ...
        a = a.g;
        var d = +b;
        if (0 === d) ((Nc = 0 < 1 / d ? 0 : 2147483648), (Mc = 0));
        else if (isNaN(d)) ((Nc = 2147483647), (Mc = 4294967295));
        else if (
          ((d = (c = 0 > d ? -2147483648 : 0) ? -d : d),
          1.7976931348623157e308 < d)
        )
          ((Nc = (c | 2146435072) >>> 0), (Mc = 0));
    ...
    Fe = ye(function (a, b, c) {
      b = C(b, c);
      null != b &&
        ('string' === typeof b && Uc(b),
        null != b &&
          (ed(a, c, 0),
          'number' === typeof b
            ? ((a = a.g), Oc(b), Zc(a, Mc, Nc))
            : ((c = Uc(b)), Zc(a.g, c.h, c.g))));
    }),
    Ge = ye(Ae),
    He = ye(Ae),
    Ie = ye(function (a, b, c) {
      b = zd(C(b, c));
      null != b && (ed(a, c, 0), a.g.g.push(b ? 1 : 0));
    }),
    ...
    Me = ye(function (a, b, c) {
      b = Dd(C(b, c));
      null != b && ((b = parseInt(b, 10)), ed(a, c, 0), ad(a.g, b));
    });
  function Ne(a) {
    return function () {
      var b = new cd();
  ...
  var Se = function (a) {
      return a instanceof Re && a.constructor === Re && a.h === Qe
        ? a.g
        : 'type_error:Const';
    },
    Qe = {},
  ...
  var Ze = function (a, b, c, d) {
      return a.addEventListener ? (a.addEventListener(b, c, Ye(d)), !0) : !1;
    },
    $e = function (a, b, c) {
  ...
  var zf = function (a) {
      return a instanceof yf && a.constructor === yf
        ? a.g
  ...
  var Df = function (a) {
      return a instanceof Cf && a.constructor === Cf
        ? a.g
        : 'type_error:SafeUrl';
    },
    Ef;
  ...
  var Of = function (a) {
      return a instanceof Nf && a.constructor === Nf
        ? a.g
        : 'type_error:SafeHtml';
    },
    Pf = function (a) {
  ...
  var dg = function (a) {
    ...
    jg = function (a) {
      ...
      return fc && a.pageYOffset != b.scrollTop
        ? new Sf(b.scrollLeft, b.scrollTop)
        : new Sf(a.pageXOffset || b.scrollLeft, a.pageYOffset || b.scrollTop);
    },
    G = function (a) {
    ...
    og = function (a) {
      var b;
      if (ef && (b = a.parentElement)) return b;
      b = a.parentNode;
  ...
  var tg = function () {
      return pb && tb
        ? tb.mobile
        : !sg() && (x('iPod') || x('iPhone') || x('Android') || x('IEMobile'));
    },
    sg = function () {
      return pb && tb
        ? !tb.mobile && (x('iPad') || x('Android') || x('Silk'))
        : x('iPad') || (x('Android') && !x('Mobile')) || x('Silk');
    };
  var ug = RegExp(
      '^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$'
    ),
...
*/
  ...
  var Ig = function (a) {
    ...
    Kg = function (a) {
      var b = void 0 === b ? !1 : b;
      var c = void 0 === c ? u : c;
      for (var d = 0; c && 40 > d++ && ((!b && !Ig(c)) || !a(c)); ) c = Jg(c);
    },
    Lg = function () {
      var a = window;
      Kg(function (b) {
  ...
  var Pg = function () {
    ...
    Tg = function (a) {
      for (var b = a; a && a != a.parent; ) ((a = a.parent), Ig(a) && (b = a));
      return b;
    };
  ...
  var Zg = function () {
    ...
    eh = function () {
      if (dh) var a = dh;
        ...
        a =
          ...
          'object' == typeof b.S
            ? (dh = b)
            : (a.google_persistent_state_async = dh = new Zg());
      }
      return ch(a);
    },
    dh = null,
    fh = {},
    ah =
      ((fh[8] = 'google_prev_ad_formats_by_region'),
  ...
  function vh() {
    var a = void 0 === a ? u : a;
    var b = Math.min(
      uh('domLoading', a) || Infinity,
      uh('domInteractive', a) || Infinity
    );
    return Infinity === b
      ? Math.max(uh('responseEnd', a), uh('navigationStart', a))
      : b;
  }
  ...
  Ah.prototype.H = function () {
    this.j = !1;
    this.B != this.g.google_js_reporting_queue &&
      (zh() && Hb(this.B, Bh), (this.B.length = 0));
  };
  ...
  var Bh = function (a) {
    a &&
      xh &&
      zh() &&
      (xh.clearMarks('goog_' + a.label + '_' + a.uniqueId + '_start'),
    ...
    Kh = function (a, b, c, d, e, f, g, h) {
      ...
      this.ta = function () {
        ...
        (null != n.hidden
          ...
          : null != n.mozHidden
            ? n.mozHidden
            : null != n.webkitHidden && n.webkitHidden) && k.ka();
      };
  ...
  var Jh = function (a) {
    ...
    Nh = function (a, b, c, d, e) {
      e = void 0 === e ? '' : e;
      var f = Lh(a, b, c, d, e);
      8e3 < a.o + a.h + f && (Fh(a), (f = b.length + c.length + 2));
      Mh(a, b, c, d, e);
      a.h += f;
      Hh(a);
    },
    ...
    Mh = function (a, b, c, d, e) {
      a.A[b] =
        d && null != a.A[b] ? a.A[b] + ('' + (void 0 === e ? '' : e) + c) : c;
    },
    Hh = function (a) {
      6e3 <= a.o + a.h && Fh(a);
    },
    ...
    Oh = function (a, b) {
      ...
      b.google_timing_params &&
        ((c = Dh(c, b.google_timing_params, d)),
  ...
  Kh.prototype.K = function (a) {
    this.j && this.D < this.L && (Ah.prototype.K.call(this, a), Gh(this, a));
  };
  ...
  var K = function () {
    ...
    L = function (a, b, c) {
      if (null != c) {
        a = a.g;
        var d = b + '=' + c;
        a.I[d] || (Nh(a, b, c, !1), 1e3 > d.length && (a.I[d] = !0));
      }
    },
    Ph = function (a, b) {
      for (var c in b)
      ...
      var d = 0,
        e;
      for (e in b) (null != a.A[e] && (c = !0), (d += Lh(a, e, b[e], !1)));
      (8e3 < a.o + a.h + d || c) && Fh(a);
      for (var f in b) Mh(a, f, b[f], !1);
      a.h += d;
      Hh(a);
    },
    Qh = function (a) {
  ...
  var Zh = function () {
    ...
    ai = function (a) {
      ...
      try {
        ...
        return ($h('missing-element', a.g), null);
      }
      if (1 < b.length) return ($h('multiple-elements', a.g), null);
      b = b[0];
      return b ? b.innerHTML : ($h('missing-element', a.g), null);
    },
    ci = function () {
      var a = bi,
        b = ai(a);
      if (null !== b)
        if (Rh(b)) {
          ...
          'string' !== typeof b
            ? $h('missing-flags', a.g)
            : (e || $h('missing-binary-id', a.g), (a.j = b));
        } else $h('invalid-json', a.g);
    };
  ...
  hi.prototype.reset = function () {
    for (var a = q(this.g), b = a.next(); !b.done; b = a.next())
      ((b = q(b.value)), b.next(), (b.next().value.g = !1));
    this.h = !1;
    this.o.reset();
  };
  var ii = new hi(),
  ...
  function Bi() {
    ...
    1 == b.length &&
      16 == ae(b[0], 1) &&
      Td(b[0], ui, 2).forEach(function (c) {
        var d = Yd(Bd(C(c, 1)), 0),
          e = Rd(c, oi, 3),
          f = a[ae(c, 4)];
  ...
  var jj,
    kj = (
      null == (jj = window.document.featurePolicy)
        ? 0
        : jj.allowedFeatures().includes('attribution-reporting')
    )
      ? 300
      : 0;
  M({
  ...
  var lj,
    mj =
      (null == (lj = window.document.featurePolicy) ||
        lj.allowedFeatures().includes('attribution-reporting'),
      0);
  M({
    id: 44769484,
    C: mj,
  ...
  vj.prototype.isVisible = function () {
    return this.ib ? 0.3 <= this.aa : 0.5 <= this.aa;
  };
  var wj = {
      ng: 0,
      tg: 1,
  ...
  var Xj = RegExp('^https?://(\\w|-)+\\.cdn\\.ampproject\\.(net|org)(\\?|/|$)'),
    bk = function (a) {
      a = a || Yj();
      for (
        var b = new Zj(u.location.href, !1), c = null, d = a.length - 1, e = d;
        0 <= e;
        --e
      ) {
        var f = a[e];
    ...
    Yj = function () {
      ...
      if (
        ...
        for (a = 1; a < b.length; ++a)
          ((e = b[a]),
            e.url ||
              ((e.url = d.location.ancestorOrigins[a - 1] || ''), (e.Sc = !0)));
      return b;
    },
    ak = function (a, b, c) {
      this.g = a;
  ...
  var kk = function (a, b) {
    ...
    mk = function () {
      ...
      !a.url ||
        ((e || d) && a != e) ||
        ((d = Og(a.url)) && g.push([new kk([d, 1], c(a.depth, b))]));
      g.push([]);
  ...
  var uk = function (a) {
    ...
    vk = function (a, b) {
      return function () {
        ...
        try {
          return ((a.g = a.j.g.g()), b.apply(null, ia(c)));
        } finally {
          ((a.o += a.j.g.g() - a.g), (a.g = -1), (a.h += 1));
        }
      };
    };
  var wk = function (a, b) {
  ...
  l.kb = function (a, b, c) {
    ...
    return vk(N().g.g, function () {
      try {
        ...
        var g = d.j;
        try {
          (Bh(e), (g = d.B(a, new Gk(Hk(h)), void 0, c)));
        } catch (k) {
          d.La(217, k);
        }
        if (!g) throw h;
  ...
  var Ek,
    ...
    Jk = function () {
      O &&
        ...
        (O.google_measure_js_timing || Dk.H());
    };
  Ek = new (function () {
    var a = 'https:';
  ...
  function el(a, b, c) {
    try {
      ...
      try {
        var e = (void 0 === c ? 0 : c)
          ? new F(d.innerWidth, d.innerHeight).round()
          : ig(d || window).round();
      } catch (n) {
  ...
  var gl = function (a, b) {
      if ('string' === typeof b) (b = fl(a, b)) && (a.style[b] = void 0);
      else
        for (var c in b) {
          var d = a,
            e = b[c],
    ...
    fl = function (a, b) {
      ...
      if (!c) {
        ...
        c = d;
        void 0 === a.style[d] &&
          ((d = (ic ? 'Webkit' : hc ? 'Moz' : fc ? 'ms' : null) + $f(d)),
    ...
    ml = function (a, b) {
      var c = new Sf(0, 0),
        d = G(cg(a));
      if (!bc(d, 'parent')) return c;
      do {
        if (d == b) var e = ll(a);
        else ((e = kl(a)), (e = new Sf(e.left, e.top)));
        c.x += e.x;
        c.y += e.y;
      } while (
        d &&
    ...
    ol = function (a) {
      ...
      return (void 0 === b || d) && a.getBoundingClientRect
        ? ((a = kl(a)), new F(a.right - a.left, a.bottom - a.top))
        : new F(b, c);
    },
    tl = function (a) {
      var b = cg(a),
      ...
      if (
        ...
        return (
          (b = ql(a, c.width, 'width', 'pixelWidth')),
  ...
  function Dl() {
    ...
    return a
      ? Mb(
          'Android TV;AppleTV;Apple TV;GoogleTV;HbbTV;NetCast;Opera TV;POV_TV;SMART-TV;SmartTV;TV Store;AmazonWebAppPlatform;MiBOX'.split(
            ';'
          ),
          function (b) {
            return lb(a, b);
  ...
  function Fl() {
    ...
    (a =
      ...
      lb(sb(), 'Xbox') ||
      El()) ||
      ((a = sb()), (a = lb(a, 'sdk_google_atv_x86') || lb(a, 'Android TV')));
    return a;
  }
  var Hl = function () {
      this.j = !Ig(O.top);
      ...
      a =
        0 < a.length && null != a[a.length - 1] && null != a[a.length - 1].url
          ? ((a = a[a.length - 1].url.match(ug)[3] || null)
              ? decodeURI(a)
              : a) || ''
          : '';
      this.domain = a;
    ...
    Gl = function (a) {
      O &&
        O.document &&
        ((a.H = el(!1, O, a.B)), (a.g = el(!0, O, a.B)), Jl(a, O), Il(a, O));
    },
    Ll = function () {
      var a = Kl();
  ...
  var Rl = function (a, b) {
    Qb(a.A, b) || (a.A.push(b), b.wb(a.g), b.Wa(a.l), b.Fa() && (a.F = !0));
  };
  ...
  l.wb = function (a) {
    ...
    b !== this.g
      ? ((this.H = this.g.H), Pl(this))
      : this.H !== this.g.H && ((this.H = this.g.H), Pl(this));
  };
  l.Wa = function (a) {
    if (a.h === this.g) {
      var b = this.l,
  ...
  l.create = function (a, b, c) {
    var d = null;
    this.g && ((d = this.Tb(a, b, c)), Rl(this.g, d));
    return d;
  };
  l.td = function () {
    return this.Db();
  ...
  l.init = function (a) {
    return this.g.initialize() ? (Rl(this.g, this), (this.o = a), !0) : !1;
  };
  l.wb = function (a) {
      ...
      : 'boolean' === typeof a
        ...
        : Array.isArray(a)
          ? 0 === a.length
            ? b
            : b + '=' + a.join()
          : b + '=' + (Qb(['mtos', 'tos', 'p'], b) ? a : encodeURIComponent(a));
  };
  var em = function (a) {
    var b = void 0 === b ? !0 : b;
    this.g = new $l();
  ...
  var xm = function () {
      ...
      this.G = this.B = -1;
      this.Z = 1e3;
      this.ca = new mm([1, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1, 0]);
      this.L = this.I = -1;
    },
    ym = function (a, b) {
  ...
  function Jm(a, b, c) {
    ...
    if (!a) return !1;
    b =
      (b = (b = cg(c)) && b.defaultView && b.defaultView.frameElement) &&
      Im(b, a);
    var d = a === c;
    a =
      !d &&
  ...
  Nm.prototype.M = function () {
    this.sa.g &&
      (this.ab.Yc &&
        ($e(this.sa.g, 'mouseover', this.ab.Yc), (this.ab.Yc = null)),
      this.ab.Xc &&
        ($e(this.sa.g, 'mouseout', this.ab.Xc), (this.ab.Xc = null)));
    this.Qb && this.Qb.V();
    this.da && this.da.V();
    delete this.tc;
    delete this.Vc;
    ...
    if ((b = a && a.getAttribute))
      b = /-[a-z]/.test('googleAvInapp')
        ...
        : Rj && a.dataset
          ...
          : a.hasAttribute
            ? a.hasAttribute('data-' + Zf())
            : !!a.getAttribute('data-' + Zf());
    b && (Kl().h = !0);
  };
  ...
  var Om = function (a, b) {
      b != a.yb && ((a.yb = b), (a = Kl()), b ? a.A++ : 0 < a.A && a.A--);
    },
    Pm = function (a, b) {
      if (a.da) {
      ...
      if ((b = null != b && b.Gc() ? b : null)) a.da = b;
    },
    Qm = function (a, b, c) {
      if (
        !a.kc ||
  ...
  l.nd = function (a, b, c, d, e, f, g) {
    this.Ja ||
      (this.Hb &&
        ((a = this.Ic(a, c, e, g)),
        (d = d && this.pa.aa >= (this.ib() ? 0.3 : 0.5)),
        this.od(f, a, d),
        (this.lc = b),
  ...
  var an = function (a, b, c, d) {
      ...
      return function (e) {
        var f = e[a];
        if (Array.isArray(f) && d(e)) return $m(f, b, c);
      };
    },
    bn = function (a, b) {
      return function (c) {
    ...
    $m = function (a, b, c) {
      return void 0 === c || c
        ...
        : Kb(b, function (d, e, f) {
            return a.slice(0 < e ? f[e - 1] + 1 : 0, d + 1).reduce(function (
              g,
              h
            ) {
              return g + h;
  ...
  var nn = function (a) {
      var b = lf(a.h),
        ...
        d;
      for (d in a.g)
        Qb(b, d) && 1 == a.g[d] && ((c += a.h[d][1]), (a.g[d] = 2));
      return c;
    },
    on = function (a) {
      var b = 0,
  ...
  l.od = function (a, b, c) {
    ...
    -1 != b.h &&
      ...
      1 == b.h &&
        (this.fa.reportEvent('b'), Zm(b) && this.fa.reportEvent('umutb')));
  ...
  En.prototype.Ic = function (a, b, c, d) {
    ...
    a.volume = c.volume;
    Cl(a.volume) ||
      (this.ta++, (b = this.pa), Cl(b.volume) && (a.volume = b.volume));
    c = c.currentTime;
  ...
  var In = function (a) {
    ...
    Hn = function (a, b) {
      2 == a.la
        ...
        : -1 == a.lc
          ? (b = 0)
          : ((b -= a.lc), (b = b > Math.max(1e4, a.j / 3) ? 0 : b));
      var c = a.B(a) || {};
      c = void 0 !== c.currentTime ? c.currentTime : a.G;
      var d = c - a.G,
        e = 0;
      0 <= d
        ? ((a.I += b), (a.T += Math.max(b - d, 0)), (e = Math.min(d, a.I)))
        : (a.X += Math.abs(d));
      0 != d && (a.I = 0);
  ...
  En.prototype.Kc = function (a) {
    return (Kl(), this.yb ? 1 : Nm.prototype.Kc.call(this, a));
  };
  ...
  var Ln = function (a, b) {
    ...
    Tn = function (a, b, c, d, e) {
      ...
      n.efpf = a.Ra;
      if ('gsv' == m || 'nis' == m) ((f = a.da), 0 < f.A && (n.nnut = f.A));
      n.tcm = In(a);
      n.nmt = a.X;
      n.bt = a.T;
      n.pst = a.Y;
      ...
      a.da && vf(n, a.da.Va());
      d
        ? ((n.c = vl(a.pa.aa, 2)), (n.ss = vl(a.pa.ra, 2)))
        : (n.tth = Uk() - Rk);
      n.mc = vl(k.G, 2);
      n.nc = vl(k.B, 2);
      n.mv = Gn(k.A);
  ...
  var lo = function (a, b) {
      ...
      return -1 != c ? (a.splice(c, 1), b.da && b.da.Sb(), b.V(), !0) : !1;
    },
    mo = function (a) {
      var b = jo;
      if (lo(b, a)) {
  ...
  var ro = function (a) {
    ...
    for (var b = 1; b < a.length; b++) Rl(a[b - 1], a[b]);
    return a;
  };
  var to = {
  ...
  Bo.prototype.G = function () {
    var a = Ao();
    this.D !== a &&
      (this.g != this && a > this.g.D && ((this.g = this), Pl(this)),
      (this.D = a));
    return 2 == a;
  };
  var Ao = function () {
    ...
    Ho = function (a, b, c) {
      if (!a.done && (a.h.cancel(), 0 != b.length)) {
        ...
        try {
          ...
          N().l = d;
          if (null != J(po).g)
            for (var e = 0; e < b.length; e++) Rm(b[e], d, c);
          for (d = 0; d < b.length; d++) Sm(b[d]);
          ++a.g.Jd;
        } finally {
          c
            ? Hb(b, function (f) {
          ...
          : 'ima_html5_sdk'.includes('admob-native-video-javascript')
            ...
            : 'av.default_js_unreleased_RCxx'.includes('cast_js_sdk')
              ...
              : 'av.default_js_unreleased_RCxx'.includes('youtube.player.web')
                ...
                : 'av.default_js_unreleased_RCxx'.includes(
                      'outstream_web_client'
                    )
                  ? {
                      Ca: 'out',
                      Da: Qo(),
  ...
  mp.prototype.initialize = function () {
    var a = this;
    if (this.j) return !this.Jb();
    this.j = !0;
    if (2 === this.h.dc) return ((this.K = 'ng'), Ql(this, 'w'), !1);
    if (1 === this.h.dc) return ((this.K = 'mm'), Ql(this, 'w'), !1);
    Kl().K = !0;
  ...
  var op = function (a) {
    ...
    rp = function (a) {
      'string' === typeof a.h.xa.AFMA_LIDAR
        ? ((a.L = !0), sp(a))
        : ((a.h.dc = 3), (a.K = 'nc'), Ql(a, 'w'));
    },
    sp = function (a) {
      a.J = !1;
      var b = 1 == Lj(N().R, 'rmmt'),
      ...
      (b ? !c : 1) &&
        pk().setTimeout(
          Mk(524, function () {
            a.J || (tp(a), Nk(540, Error()), (a.K = 'mt'), Ql(a, 'w'));
          }),
          500
        );
      up(a);
  ...
  var wp = function (a, b) {
    if ('loading' === a.B('getState')) return new F(-1, -1);
    b = a.B(b);
  ...
  var qp = function () {
    ...
    pp = function (a) {
      var b = N(),
        c = J(mp);
      a && !b.o && ((b.o = !0), (c.ga = !0), c.K && Ql(c, 'w', !0));
    };
  ...
  yp.prototype.wb = function (a) {
    switch (a.Ia()) {
      case 0:
        if ((a = J(po).g))
          ((a = a.g), Rb(a.A, this), a.F && this.Fa() && Tl(a));
        Cp();
        break;
      case 2:
        Go();
  ...
  var Hp = function (a, b) {
    if (!a.Ba) {
      ...
      b =
        '//pagead2.googlesyndication.com/pagead/gen_204?' + dm(bm(new $l(), d));
      gm(b);
      a.Ba = !0;
    }
  };
  ...
  var Mp = function (a, b) {
    b.D = 0;
    for (var c in Yk) null == a[c] && (b.D |= Yk[c]);
    Lp(a, 'currentTime');
    Lp(a, 'duration');
  };
  l = yp.prototype;
  ...
  var Lp = function (a, b) {
    ...
    Jp = function () {
      ...
      return Object.assign(
        ...
        ((b.sv = '954'), b),
        null !== To && ((c.v = To), c),
        ((d['if'] = a.j ? '1' : '0'), (d.nas = String(jo.g.length)), d)
      );
    };
  var Np = function (a) {
  ...
  Tp.prototype.g = function (a) {
    if (!a.playerId) return Rp.prototype.g.call(this, a);
  ...
  Up.prototype.K = function (a, b) {
    ...
    e ||
      (b.opt_overlayAdElement
        ? (e = void 0)
        : b.opt_adElement && (e = Kp(this, a, b.opt_adElement, b.opt_osdId)));
    e &&
      1 == e.ua() &&
      (e.B == Te &&
        (e.B = function (f) {
    ...
    a.h ||
      (void 0 === d
        ...
        : null === d
          ...
          : rf(d)
            ? (a.h |= 32)
            : null != d.errorCode && ((a.L = d.errorCode), (a.h |= 64)));
    null == d && (d = {});
    Mp(d, a);
  ...
  Up.prototype.gd = function (a) {
    !a.g &&
      a.Ja &&
      Gp(this, a, 'overlay_unmeasurable_impression') &&
      (a.g = !0);
  };
  Up.prototype.Yd = function (a) {
    a.be &&
      (a.Ka()
        ? Gp(this, a, 'overlay_viewable_end_of_session_impression')
        : Gp(this, a, 'overlay_unviewable_impression'),
      (a.be = !1));
  };
  var bq = function (a, b, c, d) {
    ...
    var f = a.K(b, c);
    c = f ? f.dd : a.Lc();
    if (e.opt_bounds) return c.g(Vo('ol', d));
    if (void 0 !== d)
      if (void 0 !== Uo(d))
        if (Oo) a = Vo('ue', d);
        else if ((Dp(a), 'i' == No)) ((a = Vo('i', d)), (a['if'] = 0));
        else if ((b = a.K(b, e))) {
          b: {
            'i' == No && ((b.Ja = !0), a.hd(b));
            f = e.opt_fullscreen;
            ...
            if ((g = !g))
              c: {
                if (Lj(N().R, 'ssmol') && ((g = a.o), 'loaded' === f)) break c;
                g = Qb(Zk, f);
              }
            if (g && 0 == b.la) {
              'i' != No && (Eo.done = !1);
  ...
  var cq = function (a, b) {
    ...
    Zp = function (a) {
      return (N(), 'h' != Fp(a) && 'm' != Fp(a)) ? !1 : 0 != a.I;
    };
  ...
  Up.prototype.Id = function () {
    this.g || (this.g = this.Mc());
    return null == this.g || this.o
      ? new xn()
      : 'ACTIVE_VIEW_TRAFFIC_TYPE_AUDIO' === this.H
        ? new Pp(this.g)
        : new hp(this.g);
  };
  ...
  u.console &&
    'function' === typeof u.console.log &&
    Wa(u.console.log, u.console);
  var lq = function (a) {
  ...
  vq.prototype.add = function (a, b, c, d, e) {
    ...
    -1 < g
      ? ((b = a[g]), c || (b.Yb = !1))
      : ((b = new tq(b, this.src, f, !!d, e)), (b.Yb = c), a.push(b));
    return b;
  };
  vq.prototype.remove = function (a, b, c, d) {
    ...
    b = wq(e, b, c, d);
    return -1 < b
      ? (uq(e[b]), Sb(e, b), 0 == e.length && (delete this.g[a], this.h--), !0)
      : !1;
  };
  var xq = function (a, b) {
    var c = b.type;
    c in a.g &&
      Rb(a.g[c], b) &&
      (uq(b), 0 == a.g[c].length && (delete a.g[c], a.h--));
  };
  ...
  var wq = function (a, b, c, d) {
    for (var e = 0; e < a.length; ++e) {
      var f = a[e];
      if (!f.Ob && f.listener == b && f.capture == !!c && f.jc == d) return e;
    }
    return -1;
  };
  var yq = 'closure_lm_' + ((1e6 * Math.random()) | 0),
    ...
    Cq = function (a, b, c, d, e) {
      if (d && d.once) return Bq(a, b, c, d, e);
      if (Array.isArray(b)) {
        for (var f = 0; f < b.length; f++) Cq(a, b[f], c, d, e);
        return null;
      }
      c = Dq(c);
      return rq(a)
        ? a.N(b, c, Pa(d) ? !!d.capture : !!d, e)
        : Eq(a, b, c, !1, d, e);
    },
    ...
    Bq = function (a, b, c, d, e) {
      if (Array.isArray(b)) {
        for (var f = 0; f < b.length; f++) Bq(a, b[f], c, d, e);
        return null;
      }
      c = Dq(c);
      return rq(a)
        ? a.Lb(b, c, Pa(d) ? !!d.capture : !!d, e)
        : Eq(a, b, c, !0, d, e);
    },
    Jq = function (a, b, c, d, e) {
      if (Array.isArray(b))
        for (var f = 0; f < b.length; f++) Jq(a, b[f], c, d, e);
      else
        ((d = Pa(d) ? !!d.capture : !!d),
          (c = Dq(c)),
          rq(a)
            ? a.nb(b, c, d, e)
            : a && (a = Fq(a)) && (b = a.Ib(b, c, d, e)) && Kq(b));
    },
    Kq = function (a) {
      if ('number' !== typeof a && a && !a.Ob) {
        ...
        if (rq(b)) xq(b.o, a);
          ...
          b.removeEventListener
            ...
            : b.detachEvent
              ? b.detachEvent(Hq(c), d)
              : b.addListener && b.removeListener && b.removeListener(d);
          Aq--;
          (c = Fq(b))
            ? (xq(c, a), 0 == c.h && ((c.src = null), (b[yq] = null)))
            : uq(a);
        }
      }
    },
  ...
  l.dispatchEvent = function (a) {
    ...
    c = this.Wb;
    var d = a.type || a;
    if ('string' === typeof a) a = new mq(a, c);
    else if (a instanceof mq) a.target = a.target || c;
    else {
      var e = a;
      a = new mq(d, c);
      vf(a, e);
    ...
    if (b)
      for (f = 0; !a.h && f < b.length; f++)
        ((g = a.currentTarget = b[f]), (e = Mq(g, d, !1, a) && e));
    return e;
  };
  l.M = function () {
    P.za.M.call(this);
    if (this.o) {
      var a = this.o,
        ...
        c;
      for (c in a.g) {
        for (var d = a.g[c], e = 0; e < d.length; e++) (++b, uq(d[e]));
        delete a.g[c];
        a.h--;
      }
    }
  ...
  br.prototype.H = function () {
    for (var a; (a = ir(this)); ) jr(this, a, this.g, this.B);
    this.A = !1;
  };
  var jr = function (a, b, c, d) {
      if (3 == c && b.h && !b.o) for (; a && a.l; a = a.j) a.l = !1;
      if (b.g) ((b.g.j = null), or(b, c, d));
      else
        try {
  ...
  l.Qf = function () {
    if (this.pb) {
      var a = Ya() - this.l;
      0 < a && a < 0.8 * this.h
        ? (this.Ga = this.g.setTimeout(this.j, this.h - a))
        : (this.Ga && (this.g.clearTimeout(this.Ga), (this.Ga = null)),
          this.dispatchEvent('tick'),
          this.pb && (this.stop(), this.start()));
    }
  };
  l.start = function () {
    this.pb = !0;
    this.Ga || ((this.Ga = this.g.setTimeout(this.j, this.h)), (this.l = Ya()));
  };
  l.stop = function () {
    this.pb = !1;
    this.Ga && (this.g.clearTimeout(this.Ga), (this.Ga = null));
  ...
  var Dr = function (a) {
    ...
    Fr = function (a, b, c) {
      if (b && c) {
        ...
        yr(a, new zr('vp', d));
        d && 0 < d
          ? ((e = Xg(b)), (f = Xg(c)), (e = e.top >= f.top && e.top < f.bottom))
          : (e = !1);
        yr(a, new Ar(512, e));
        d && 0 < d
          ? ((e = Xg(b)),
  ...
  var Gr = function (a, b) {
    ...
    if (d) {
      ...
      m
        ? ((h = jg(dg(h.document).g)),
          yr(a, new Ar(16384, !!h)),
          (m = h ? new Wg(h.x, h.y, m.width, m.height) : null))
        : (m = null);
      yr(a, new Br('vi', m));
      if (m && '1' == k) {
        k = lq(d);
        d = [];
        for (h = 0; h < k.length; h++) (e = Er(k[h], g)) && d.push(e);
        d.push(m);
        m = Dr(d);
      }
      Fr(a, f, m);
      ...
      a.h = sr();
    } else ((a = xr()), (a.g = {}), (a.h = sr()), yr(a, new Ar(32, !1)));
    this.j = a;
    this.g = new tr();
    this.g.set('ve', 4);
    c && ur(this.g, 1);
    ...
    this.h = b = null;
    if (c && ((c = mf(G(), 'ima', 'video', 'client')), c.getEData)) {
      this.h = c.getEData();
  ...
  var Os = function (a) {
    ...
    Rs = function (a) {
      return (
        String.fromCharCode(Ls + Ps(a, 6)) + String.fromCharCode(Ls + Ps(a, 6))
      );
    },
    Us = function (a) {
      var b = Ps(a, 16);
    ...
    Ss = function (a) {
      for (var b = Ps(a, 12), c = []; b--; ) {
        var d = !0 === !!Ps(a, 1),
          e = Ps(a, 16);
        if (d) for (d = Ps(a, 16); e <= d; e++) c.push(e);
        else c.push(e);
      }
      c.sort(function (f, g) {
        return f - g;
  ...
  function mt(a) {
    return new (Function.prototype.bind.apply(
      a,
      [null].concat(ia(Ja.apply(1, arguments)))
    ))();
  }
  var Q = function (a, b) {
    ...
    a instanceof Q
      ...
      : a && (c = String(a).match(ug))
        ? ((this.l = !!b),
          ...
          pt(this, c[6] || '', !0),
          (this.K = rt(c[7] || '')))
        : ((this.l = !!b), (this.j = new tt(null, this.l)));
  };
  ...
  function Ot(a, b) {
    ...
    (null == a ? 0 : a.startsWith('https'))
      ...
      : Pt(a, Nt)
        ? (c = !1)
        : b.includes('https') && Pt(a, Mt) && (c = !0);
    return c
      ? ((a = new Q(a)), L(K.g(), 'htp', '1'), nt(a, 'https'), a.toString())
      : a;
  }
  function Qt(a) {
    if (!a) return !1;
  ...
  $t.prototype.j = function (a) {
    switch (a.type) {
      ...
      case 'ended':
        ...
        break;
      case 'timeupdate':
        !this.A && 0 < au(this) && ((this.A = !0), bu(this));
    }
  };
  var bu = function (a) {
    !a.h.pb &&
      a.A &&
      ((a.D = 1e3 * au(a)), (a.B = Date.now()), (a.l = !1), a.h.start());
  };
  ...
  var cu =
    ...
    du = /\bocr\b/;
  function eu(a) {
    if (ib(Wf(a)) || (fc && 2048 < a.length)) return !1;
    try {
      if (new Q(a).D().match(du)) return !0;
    } catch (b) {}
    return (
      null !=
      cu.find(function (b) {
        ...
        'ResizeObserver' in window
          ? ((f = new ResizeObserver(function (g) {
              window.requestAnimationFrame(function () {
                for (
                  var h = new F(0, 0), k = q(g), m = k.next();
                  !m.done;
                  m = k.next()
                )
                  if (
  ...
  function lu(a) {
    ...
    a.split(',').forEach(function (c) {
      var d = c.split('=');
      2 == d.length &&
        ((c = jb(d[0])), (d = jb(d[1])), 0 < c.length && (b[c] = d));
    });
    return b;
  }
  function mu(a) {
  ...
  var wu = function (a, b, c, d, e, f) {
    Array.isArray(c) || (c && (vu[0] = c.toString()), (c = vu));
  ...
  var xu = function (a, b, c, d, e, f) {
    if (Array.isArray(c))
      for (var g = 0; g < c.length; g++) xu(a, b, c[g], d, e, f);
    else {
  ...
  var Bu = function (a) {
    var b;
    (b = a.g) || ((b = {}), Au(a) && ((b[0] = !0), (b[1] = !0)), (b = a.g = b));
    return b;
  };
  var Cu,
    Du = function () {};
      ...
      try {
        (Ju(a),
          0 < a.D &&
            ((a.T = Ku(a.g)),
            a.T
              ? ((a.g.timeout = a.D), (a.g.ontimeout = Wa(a.ca, a)))
              : (a.B = rr(a.ca, a.D, a))),
          (a.A = !0),
          a.g.send(b),
          (a.A = !1));
  ...
  var Ou = function (a) {
      if (
        ...
        if (a.A && 4 == Pu(a)) rr(a.Y, 0, a);
        else if ((a.dispatchEvent('readystatechange'), 4 == Pu(a))) {
          a.h = !1;
          try {
            var b = Qu(a);
            a: switch (b) {
            ...
            if (!(d = c)) {
              ...
              if ((e = 0 === b)) {
                ...
                !f &&
                  u.self &&
                  u.self.location &&
                  (f = u.self.location.protocol.slice(0, -1));
      ...
      return new Promise(function (n, r) {
        m.Lb(h, 'success', function () {
          a: {
            ...
            h.g && 4 == Pu(h)
              ? ((v = h.g.getResponseHeader('Content-Type')),
                (v = null === v ? void 0 : v))
              : (v = void 0);
            v = v || '';
          }
          if (-1 != v.indexOf('application/json')) n(Ru(h) || {});
          else {
            try {
  ...
  var $u = function (a, b, c, d, e) {
      ...
      try {
        if (
          ((b = (void 0 === d ? 0 : d) ? Ot(b, 'https') : Ot(b)),
          (c = c || eu(b)),
          a.h)
        )
          Xu(a, b, c, e);
  ...
  var iv = function (a) {
    ...
    hv = function (a) {
      return new Map(
        a.g.split('/').reduce(function (b, c, d, e) {
          d % 2 && b.set(e[d - 1], c);
          return b;
        }, new Map())
      );
  ...
  function pv() {
    ...
    if (Db()) {
      if (void 0 === Jt) {
        ...
        a ||
          (void 0 === It && (It = kb(Kt(), 'afma-sdk-a') ? !0 : !1), (a = It));
        Jt = a;
      }
      return Jt ? !0 : sg() ? !1 : qv();
    }
    a =
      Fb() ||
      (Cb() ? 'Linux' === tb.platform : x('Linux')) ||
      (Cb() ? 'Windows' === tb.platform : x('Windows')) ||
      (Cb() ? 'Chrome OS' === tb.platform : x('CrOS'));
...
*/
  ...
  Nv.prototype.cancel = function (a) {
    if (this.j) this.h instanceof Nv && this.h.cancel();
    else {
      if (this.g) {
        var b = this.g;
        delete this.g;
  ...
  var Xv = function (a) {
    ...
    Sv = function (a) {
      if (a.A && a.j && Xv(a)) {
        var b = a.A,
          c = Yv[b];
        c && (u.clearTimeout(c.g), delete Yv[b]);
        a.A = 0;
      }
      ...
      for (var d = (c = !1); a.l.length && !a.B; ) {
        ...
        if ((f = a.o ? g : f))
          try {
            ...
            if (
              $q(b) ||
              ('function' === typeof u.Promise && b instanceof u.Promise)
            )
              ((d = !0), (a.B = !0));
          } catch (k) {
            ((b = k), (a.o = !0), Xv(a) || (c = !0));
      ...
      d &&
        ((h = Wa(a.D, a, !0)),
        (d = Wa(a.D, a, !1)),
        b instanceof Nv ? (Vv(b, h, d), (b.I = !0)) : b.then(h, d));
      c && ((b = new Zv(b)), (Yv[b.g] = b), (a.A = b.g));
    },
    Tv = function () {
      bb.call(this);
    };
  ...
  $v.prototype.remove = function () {
    ...
    try {
      ...
      return (Ov(a, Jv(c, 'deleting via cursor')), a);
    }
  ...
  var cw = function (a, b, c) {
    ...
    try {
      ...
      return ((b += ' with key ' + zg(c)), Ov(d, Jv(f, b)), d);
    }
  ...
  ew.prototype.remove = function (a) {
    ...
    try {
      ...
      return (
        (c = 'removing from ' + this.getName() + ' with key ' + zg(a)),
        Ov(b, Jv(e, c)),
        b
      );
    }
  ...
  ew.prototype.get = function (a) {
    ...
    try {
      ...
      return (
        (c = 'getting from ' + this.getName() + ' with key ' + zg(a)),
        Ov(b, Jv(e, c)),
        b
      );
    }
  ...
  l.close = function () {
    this.Zc && (this.g.close(), (this.Zc = !1));
  };
  l.getName = function () {
    return this.g.name;
  };
  ...
  var mw = function (a) {
    ...
    void 0 == rv &&
      (rv =
        u.indexedDB || u.mozIndexedDB || u.webkitIndexedDB || u.moz_indexedDB);
    ...
    c.onupgradeneeded = function (d) {
      if (a) {
        ...
        a(
          new kw(d.oldVersion, d.newVersion),
          e,
          new iw(d.target.transaction, e)
        );
      }
    };
  ...
  nw.prototype.initialize = function () {
    var a = this;
    return Promise.resolve(mw(this.h)).then(
      function (b) {
        return (a.g = b);
      },
      function (b) {
  ...
  var pw = function (a, b) {
    ...
    uw = function (a) {
      for (
        var b = [a.Wh, a.source, a.Uh].join(), c = 0, d = 0;
        d < b.length;
        d++
      )
  ...
  yw.prototype.J = function (a) {
    1 === this.g
      ? ((this.h += a), (this.g = 2))
      : 0 === this.g && ((this.h += a), (this.g = 1), zw(this));
  };
  var zw = function (a) {
      Ia(function (b) {
        if (1 == b.g) return (2 === a.g && (a.g = 1), ya(b, Aw(a), 4));
        var c = 3 < a.G;
        if (c && null !== a.A) {
    ...
    Cw = function (a) {
      return new Promise(function (b, c) {
        ...
        d.addEventListener('load', function () {
          ...
          if (400 <= d.status)
            return (
              L(K.g(), 'lvlxes', d.status.toString()),
              (a.A = d.status),
              c()
            );
          var g = d.response;
  ...
  Ew.prototype.J = function (a) {
    1 === this.g
      ? ((this.h += a), (this.g = 2))
      : 0 === this.g && ((this.h += a), (this.g = 1), Fw(this));
  };
  var Fw = function (a) {
      Ia(function (b) {
        if (1 == b.g) return (2 === a.g && (a.g = 1), ya(b, Gw(a), 4));
        var c = 3 < a.G;
        if (c) {
          null === a.B && (a.B = 400);
          var d = nv('media_source_error', {
    ...
    Iw = function (a) {
      ...
      return Ia(function (h) {
        if (1 == h.g)
          return ((b = 0), (c = a.h - a.j), ya(h, fetch(a.D.toString()), 2));
        d = h.h;
        if (400 <= d.status)
          return (
            L(K.g(), 'lvlfes', d.status.toString()),
            (a.B = d.status),
            h.return(Promise.reject())
          );
        e = d.body.getReader();
        if (!e)
          return (Qh('lvlmr'), (a.B = d.status), h.return(Promise.reject()));
        f = [];
        g = function () {
          var k, m, n, r;
          return Ia(function (v) {
            if (1 == v.g) return ya(v, e.read(), 2);
            k = v.h;
            m = k.done;
            n = k.value;
            if (m) return ((r = b < c), Kw(a, f, r), v.return());
            f.push(n);
            b += n.length;
            Jw(a, n.buffer);
            return ya(v, g(), 0);
    ...
    Kw = function (a, b, c) {
      c && ((a.g = 3), Jw(a, new ArrayBuffer(0)));
  ...
  function Nw(a) {
    return [43, 44, 45].includes(a) && zc
      ? !1
      : ev[a]
        ? ((a = mv(a)), !!a && Mw() && MediaSource.isTypeSupported(a))
        : !1;
  }
  var Ow = function () {};
  ...
  t(Sw, P);
  var Rw = function (a) {
      for (var b = [], c = 0; c < a.h.length; ++c) b.push(new Ow());
      return b;
    },
    Qw = function (a) {
      Qh('msms_oso');
  ...
  Sw.prototype.M = function () {
    ...
    for (var a = q(this.A), b = a.next(); !b.done; b = a.next()) b.value.V();
  ...
  function ax(a, b) {
    var c = 0,
      ...
      n = !1;
    if (
      'function' === typeof Na('performance.getEntriesByType', u) &&
      'transferSize' in u.PerformanceResourceTiming.prototype
    ) {
        ...
        ((v = v.value),
          Vw.test(v.name) ||
            ...
            v.transferSize
              ? ((c += v.transferSize),
                v.encodedBodySize &&
                  v.transferSize < v.encodedBodySize &&
                  ((h += 1),
                  (e += v.encodedBodySize),
                  Ww.test(v.name) && (m = !0),
                  Xw.test(v.name) && (n = !0)),
                Zw.test(v.name) && (d += v.transferSize))
    ...
    } else L(K.g(), 'error', 'reporting_timing_not_supported');
  }
  function bx(a) {
    var b = K.g(),
  ...
  fx.prototype.B = function (a, b) {
    ...
    if (c) {
      ...
      if (this.D)
        ...
        this.o++;
        try {
          for (e = 0, f = c.length; e < f && !this.va(); e++)
  ...
  var Gx = function (a, b, c) {
      c !== a.P.getAttribute(b) &&
        (null === c ? a.P.removeAttribute(b) : a.P.setAttribute(b, c));
    },
    Hx = function (a) {
      a.ha &&
        (a.P.removeEventListener('timeupdate', a.Mb), a.ha.V(), (a.ha = null));
    },
    Ix = function (a, b) {
      a.Cd = b;
    ...
    Ax = function (a) {
      ...
      a.P.addEventListener('play', function () {
        a.Zd || (ax(a.P, 'first_play'), (a.Zd = !0));
      });
      a.P.addEventListener('pause', function () {
        a.Ac || (ax(a.P, 'first_pause'), bx(a.P), (a.Ac = !0));
      });
      ...
      if (u.MutationObserver) {
        var b = new MutationObserver(function (c) {
          ...
          for (var d = c.next(); !d.done; d = c.next())
            if (
              ((d = d.value), 'childList' === d.type && (d = xx(d.addedNodes)))
            ) {
              Mx(a, d);
              b.disconnect();
              break;
    ...
    Fx = function (a) {
      ...
      if (!a.Gb && !a.tb && a.ha) (Hx(a), Gx(a, 'src', null), a.P.load());
      else if (a.Gb && a.tb) {
        var b = lv(a.Gb),
          c = lv(a.tb);
        if (c && Nw(c))
          if (b && Nw(b)) {
            ...
            Gx(a, 'src', a.ha.j);
            a.ce || a.P.load();
          } else Ix(a, new zx('Audio itag "' + b + '" not supported.'));
        else Ix(a, new zx('Video itag "' + c + '" not supported.'));
      }
    },
    Jx = function (a) {
      for (
        var b = {}, c = q(tx), d = c.next();
        !d.done;
        b = {
          Aa: b.Aa,
          Fc: b.Fc,
        ...
        ((b.Aa = d.value),
          b.Aa in a.P &&
            ('function' === typeof a.P[b.Aa]
              ? ((b.Fc = a.P[b.Aa].bind(a.P)),
  ...
  Dx.prototype.disconnectedCallback = function () {
    ...
    wx.prototype.disconnectedCallback &&
      wx.prototype.disconnectedCallback.call(this);
  };
  ...
  u.customElements &&
    (u.customElements.get('lima-video') ||
      u.customElements.define('lima-video', Dx));
  function Ox() {
    var a = mt(nw);
    a.initialize().then(function (b) {
      b && ((b = nv('initialized')), a.dispatchEvent(b));
    });
    return a;
  }
  var Qx = function (a, b, c, d, e) {
    ...
    this.X = 0.1;
    if ((this.l = pv())) ((this.A = Ox()), cf(this, this.A));
    Px(this);
  };
  t(Qx, E);
  var Rx = function (a, b) {
    ...
    Px = function (a) {
        ...
        a.h.buffered.length &&
          ...
          a.l
            ...
            : a.J &&
              ...
              a.j === a.D &&
              (Qh('sl_lc' + a.o), a.ka()));
        !a.ta && 1 < a.G.buffered.length && (L(K.g(), 'dbr', '1'), (a.ta = !0));
      });
      ...
      a.l
        ? (ow(a.A)
            ? Vx(a)
            : (a.Ra = Cq(a.A, 'initialized', function () {
                Vx(a);
              })),
    ...
    Ux = function (a) {
      ...
      -1 !== b && b < a.Y + a.F
        ...
        : ((b = a.D === a.j && !a.h.updating && !a.B.length),
          (b = a.l
            ? !a.jb && b && a.G.currentTime >= a.X
            : !a.J && b && a.G.currentTime >= a.X));
      b && ((a.X = a.Wb + 0.1), Vx(a));
    },
    Wx = function (a) {
  ...
  var by = function (a) {
    ...
    $x = function (a) {
      ...
      a.o = function () {
        if (!a.A)
          for (var e = q(a.j), f = e.next(); !f.done; f = e.next()) Ux(f.value);
      };
  ...
  ay.prototype.M = function () {
    ...
    for (var a = q(this.j), b = a.next(); !b.done; b = a.next()) b.value.V();
    by(this);
...
*/
  ...
  var iy = function (a) {
    ...
    var b = a.indexOf(';'),
      c = null;
    0 <= b
      ? ((this.g = a.substring(0, b)), (c = a.substring(b + 1)))
      : (this.g = a);
    hy(this, c);
  };
  t(iy, Q);
  ...
  var hy = function (a, b) {
    ...
    ky = function (a) {
      if (ib(Wf('ord'))) return null;
      a = a.B.get('ord');
      return null != a ? a : null;
    },
    ly = function (a, b) {
      ib(Wf('ord')) || ((b = b.map(Wf)), a.B.set('ord', b));
    },
    jy = function (a, b) {
      b = [Wf(b)];
  ...
  function oy(a) {
    var b = {};
    a = ((b['x-afma-token-requester-type'] = a), b);
    return new Su()
      .get({
  ...
  var Cy = function (a, b) {
      ...
      this.resourceType = By(yy, this.settings.resourceType)
        ? this.settings.resourceType
        : 'All';
      this.creativeType = By(wy, this.settings.creativeType)
        ? this.settings.creativeType
        : 'All';
      this.sizeCriteria = By(zy, this.settings.sizeCriteria)
    ...
    Fy = function (a, b) {
      ...
      b.forEach(function (d) {
        a.settings.allowCustom &&
          ...
          Dy(a, d)
            ? c.push(d)
            : ((d = Ey(a, d)), null != d && !ib(d.getContent()) && c.push(d)));
      });
      return c;
    };
  ...
  var Dy = function (a, b) {
      ...
      if (c)
        if (((c = b.getSize()), (b = !!b.data.fluidSize) || a.g.Ld))
          a = b && a.g.Ld;
        else if (
  ...
  var Iy = function (a) {
    ...
    Jy = function (a, b) {
      return nf(a.g, b) && ((a = a.g[b]), 'boolean' === typeof a) ? a : !1;
    },
    Ky = function (a) {
  ...
  W.prototype.getDisableCustomPlaybackForIOS10Plus =
    W.prototype.getDisableCustomPlaybackForIOS10Plus;
  W.prototype.setDisableCustomPlaybackForIOS10Plus =
    W.prototype.setDisableCustomPlaybackForIOS10Plus;
  ...
  Qy.prototype.M = function () {
    this.A = {};
    this.j && ($e(this.h, 'message', this.j), delete this.j);
    delete this.A;
    delete this.h;
    delete this.g;
    E.prototype.M.call(this);
  ...
  var Yy = function (a, b) {
    ...
    Zy = function (a, b) {
      ...
      var d = c.g;
      (c =
        gb(c.h, 'googleads.g.doubleclick.net') &&
        ku('/pagead/(live/)?ads', d)) ||
        ((d = new iy(a)),
        (c = d.h),
        (d = jy(d, d.g)),
        (c =
          !gb(c, '.g.doubleclick.net') &&
          gb(c, 'doubleclick.net') &&
          ku('/(ad|pfad)[x|i|j]?/', d)));
      c ||
        ((c = new Q(a)),
        (d = c.g),
                ...
                if (
                  ...
                  c: {
                    if (
                      ...
                      ((Ca = a.publisher.restrictions['1']), void 0 !== Ca)
                    ) {
                  ...
                  0 === Ca
                    ? (d = !1)
                    : a.purpose && a.vendor
                      ? ((Ca = a.vendor.consents),
                        (d = !(!Ca || !Ca[void 0 === d ? '755' : d])) &&
  ...
  t(uz, tz);
  var wz = function (a, b) {
      a.Xa || ((a.Xa = !0), (a.Nb = b), a.zc.resolve(b), oz(ct) && vz(a));
    },
    vz = function (a) {
  ...
  Gz.prototype.start = function () {
    ...
    return Ia(function (c) {
      switch (c.g) {
        ...
        case 2:
          b = Aa(c);
          if (a.va()) return c.return();
          !(b instanceof sz) &&
            b instanceof Error &&
            (a.l(a.id, b), a.g.g.length && Hz(a, new sz(b.message)));
          c.g = 0;
      }
    });
  };
  var Fz = function (a) {
      if (!a.o && a.B)
        try {
          ...
          !(a.va() || k instanceof sz) &&
            k instanceof Error &&
            (a.l(a.id, k), a.g.g.length && Hz(a, new sz(k.message)));
        }
    },
    Iz = function (a) {
      var b = new xz();
      ...
      for (d = c.next(); !d.done; d = c.next())
        if (((d = d.value), (f = lz().get(d, a).zb)))
          if (((e = mz(f)), 2 !== e && 3 !== e)) {
            ...
            z(f.ba) & 2 && od(h, 8);
            f = {};
            iz(19, d, null, ((f.hs = e ? '1' : '0'), f));
          }
    }
    if (!Td(b, Nr, 2).length) return null;
    iz(50, '');
    return Fc(b.A(), 3);
  }
  var Pz = {};
    ...
    var a = this.G.value,
      b = function (c) {
        ...
        iz(
          ...
          C(a, 1),
          null,
          ((d.tic = String(Math.round((Date.now() - C(a, 3)) / 6e4))), d)
        );
      };
    switch (mz(a)) {
      case 0:
  ...
  Vz.prototype.h = function () {
    ...
    try {
      ...
      (iz(1, c, Wz(e)), yz(this.A, b.Oa(Lr(107))));
    }
  };
  function Wz(a) {
  ...
  Yz.prototype.h = function () {
    var a = this.A.value,
      b = C(a, 1),
      c = this.J.value;
    if (null == c) (iz(41, b), a.Oa(Lr(111)), wz(this.j, a));
    else if ('string' !== typeof c)
      (iz(21, b), (a = a.Oa(Lr(113))), wz(this.j, a));
    else {
      if (c.length > (/^(\d+)$/.test(b) ? this.G : this.I)) {
        var d = {};
        iz(12, b, null, ((d.sl = String(c.length)), d));
        b = a.Oa(Lr(108));
        Id(b, 2, void 0, !1);
      } else (c.length || iz(20, b), Id(a, 10, void 0, !1));
      wz(this.j, a);
    }
  };
  var Zz = function (a) {
  ...
  var aA = function (a, b) {
    ...
    bA = function (a, b) {
      b = q(b);
      for (var c = b.next(); !c.done; c = b.next()) aA(a, c.value);
    },
    cA = function (a) {
      ...
      Ia(function (y) {
        switch (y.g) {
          ...
          case 2:
            b = q(a.o);
            for (c = b.next(); !c.done; c = b.next())
              ((d = c.value), oz(ct) ? ((d.B = !0), Fz(d)) : d.start());
            e = q(a.A);
            for (f = e.next(); !f.done; f = e.next()) ((g = f.value), cA(g));
            if (!a.j) {
              y.g = 4;
              break;
            }
            ...
            return ya(
              y,
              Promise.all(
                Object.values(a.j).map(function (B) {
                  return B.promise;
                })
              ),
              6
          ...
          case 6:
            for (k = y.h, m = 0, n = q(h), r = n.next(); !r.done; r = n.next())
              ((v = r.value), (a.l[v] = k[m++]));
          case 4:
            return (a.h.resolve(a.l), y.return(a.h.promise));
        }
      });
    };
      ...
      return 1 == la.g
        ...
        : la.return({
            ...
            collectorGeneratedData:
              null != (Za = null == (A = la.h) ? void 0 : C(A, 2)) ? Za : null,
          });
    });
  }
  ...
  eA.prototype.h = function () {
    ...
    if (a) {
      ...
      c = {};
      iz(42, b, null, ((c.ea = String(Number(this.I))), c));
  ...
  fA.prototype.h = function () {
    if (this.j)
      if ('object' !== typeof this.j)
        (iz(46, 'UNKNOWN_COLLECTOR_ID'), gA(this, 'UNKNOWN_COLLECTOR_ID', 112));
      else {
        var a = this.j.id,
          b = this.j.networkCode;
        a && b && (delete this.j.id, iz(47, a + ';' + b));
        a = null != b ? b : a;
        'string' !== typeof a
          ? ((b = {}),
            iz(
            ...
            gA(this, 'INVALID_COLLECTOR_ID', 102))
          : 'function' !== typeof this.j.collectorFunction
            ? (iz(14, a), gA(this, a, 105))
            : J(nz).g(gt.g, gt.defaultValue).includes(a)
              ? (iz(22, a), gA(this, a, 104))
              : wz(this.G, this.j);
      }
    else
      (iz(39, 'UNKNOWN_COLLECTOR_ID'), gA(this, 'UNKNOWN_COLLECTOR_ID', 110));
  };
  ...
  hA.prototype.clearAllCache = function () {
    ...
    if (1 === this.h) {
      var c = {};
      iz(49, '', null, ((c.url = b), c));
    } else if (
      ((c = String(Ng(null != b ? b : ''))),
      J(nz).g(ft.g, ft.defaultValue).includes(c))
    )
      ((c = {}), iz(48, '', null, ((c.url = b), c)));
    else {
      var d = new $z();
  ...
  function mA(a, b, c, d) {
    ...
    e !== g
      ? iz(16, '')
      : (kA(a, 'encryptedSignalProviders', c, d) &&
          kA(a, 'secureSignalProviders', c, d)) ||
        (iz(38, ''),
        ...
        yA(
          vA(
            CA(
              xA(
                DA(
                  zA(wA(new uA(), a.architecture || ''), a.bitness || ''),
                  a.mobile || !1
                ),
                a.model || ''
              ),
  ...
  var OA = function (a) {
      a = void 0 === a ? !1 : a;
      var b = My(Ny);
      if ((b && Jy(b, 'forceCustomPlayback')) || Ny.h) return !0;
      if ((mc || Xt()) && a) return !1;
      a =
        a &&
        (mc || Xt() || Yt(10)) &&
        Ny.getDisableCustomPlaybackForIOS10Plus();
      return ((lc || nc) && !a) || (kc && (!kc || !Wt(Vt, 4))) || NA()
        ? !0
        : !1;
    },
    PA = function (a) {
        ...
        : Ny.h
          ...
          : oc || mc || Xt()
            ? Zt(a)
              ? mc ||
                Xt() ||
                (Yt(10) && Ny.getDisableCustomPlaybackForIOS10Plus())
                ? !1
                : !0
              : !0
            : (kc && (!kc || !Wt(Vt, 4))) || NA()
    ...
    RA = function () {
      return (LA.g(), LA.g(), 'tvos' === (LA.g(), null)) ? 1 : Fl() ? 2 : 0;
    };
  var SA = function (a, b) {
  ...
  $A.prototype.D = function (a) {
    ...
    if (bB(this, b)) {
      ...
      bB(this, b) &&
        this.dispatchEvent(
          new vy(b.name, b.type, b.data || {}, b.sid, a.origin)
        );
    }
  };
  var bB = function (a, b) {
  ...
  var eB = function (a, b) {
    ...
    dB = function (a) {
      fB(a);
      !(a.g instanceof P) && 'ontouchstart' in document.documentElement && oc
        ? ((a.G = {
            touchstart: function (b) {
              ...
              a.B
                ? ((a.L = Infinity), (a.O = Infinity))
                : ((a.L = b.touches[0].clientX), (a.O = b.touches[0].clientY));
              b = b.touches;
              a.l = [];
            ...
            touchmove: function (b) {
              ...
              if (
                !Yt(8) ||
                Math.pow(b.changedTouches[0].clientX - a.L, 2) +
  ...
  kB.prototype.match = function (a) {
    var b = this;
    return a
      ? this.g.some(function (c) {
          c = a.match(c);
          return null == c
            ? !1
            : !b.h ||
                (1 <= c.length && '3.578.0' === c[1]) ||
                (2 <= c.length && '3.578.0' === c[2])
              ? !0
              : !1;
        })
      : !1;
  ...
  var lB = [
    ...
    nB = [
      104, 116, 116, 112, 115, 63, 58, 47, 47, 105, 109, 97, 115, 100, 107, 46,
      103, 111, 111, 103, 108, 101, 97, 112, 105, 115, 46, 99, 111, 109, 47,
      112, 97, 108, 47, 115, 100, 107, 108, 111, 97, 100, 101, 114, 47,
    ],
    oB = [
  ...
  var tB = new kB(
      [
        104, 116, 116, 112, 115, 63, 58, 47, 47, 105, 109, 97, 115, 100, 107,
        92, 46, 103, 111, 111, 103, 108, 101, 97, 112, 105, 115, 92, 46, 99,
        111, 109, 47, 112, 114, 101, 114, 101, 108, 101, 97, 115, 101, 47, 106,
        115, 47, 91, 48, 45, 57, 93, 43, 92, 46, 91, 48, 45, 57, 92, 46, 93, 43,
        47,
      ],
      oB,
      !1
  ...
  function FB(a) {
    return (a = qg(a)) && a.omidSessionInterface
  ...
  SB.prototype.init = function (a) {
    if (!this.j) {
      if ((this.g = a || null))
        (this.B.N(this.g, 'activityMonitor', this.F), UB(this));
      if (
        !(
          u.ima &&
          u.ima.video &&
          u.ima.video.client &&
          u.ima.video.client.tagged
        )
      ) {
        ...
        var c = Bf(
          Se(new Re(Pe, 'https://s0.2mdn.net/instream/video/client.js'))
        );
        Dg(a, c);
        a.async = !0;
  ...
  var aC = function (a, b, c) {
    var d,
      e = b ? (null != (d = a.l.get(b)) ? d : null) : Ny.o;
    a = {};
    ...
    try {
      ...
      ((c = f), (c = 'sdktle;' + Uf(c.name, 12) + ';' + Uf(c.message, 40)));
    }
    return c;
  };
  ...
  l.load = function (a, b) {
    ...
    this.L = !1;
    if (b)
      if ((Qh('hvd_ad'), b instanceof lt)) {
        if ((Qh('hvd_mad'), (c = b.getMediaUrl()))) {
          Qh('hvd_admu');
          Qh('hvd_src');
          this.g.src = c;
          this.g.load();
        ...
        var d = b.h,
          ...
          g = b.Za,
          h = b.Ta;
        if (c && d && e && f && g && h && (Qh('hvd_addu'), b.ya)) {
          Qh('hvd_admse');
          b = e + '; codecs="' + g + '"';
          f = f + '; codecs="' + h + '"';
          if (
            ...
            if (a && this.g instanceof Dx)
              ((a = this.g), (a.tb = c), (a.Gb = d));
            else {
              this.Z = new ay(this.g, [
                new Pw(c, b, 35e4, new Lw()),
                new Pw(d, f, 82e3, new Lw()),
              ]);
              cf(this, this.Z);
              c = this.g;
              d = this.Z;
              if (!d.h) {
                ...
                if (
                  ...
                  if (
                    ...
                    !(
                      /^image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp|x-icon|heic|heif|avif)$/i.test(
                        b[1]
                      ) ||
    ...
    a ? (Qh('hvd_src'), (this.g.src = a)) : Qh('hvd_vn');
    this.g.load();
  };
  ...
  gC.prototype.pause = function () {
    null == this.j && ((this.X = !0), this.g.pause());
  };
  ...
  var lC = function (a) {
    if (!a.D) {
      ...
      b = void 0 === b ? !1 : b;
      ((mc || Xt() || Yt(10)) && (b || (LA.g(), 1))) ||
        (LA.g(), lb(sb(), 'Xbox')) ||
        (lc || nc
          ? 0
          : (!kc || (kc && Wt(Vt, 4))) && (El() ? (LA.g(), !1) : !NA())) ||
        !kc ||
        (kc && Wt(Vt, 3)) ||
        ((lc || nc) && !Yt(4)) ||
        kC(a);
  ...
  l.zf = function () {
    this.Y || ((this.Y = !0), this.dispatchEvent('loaded'));
  };
  l.Vd = function (a) {
    null != this.j
      ? (this.J = a)
      : (this.dispatchEvent('play'), oc || mc || Xt() || Ac || lC(this));
  };
  l.Cf = function (a) {
  ...
  l.xf = function () {
    var a = !0;
    if (oc || lb(sb(), 'Nintendo WiiU')) a = this.l >= this.g.duration - 1.5;
  ...
  gC.prototype.ta = function () {
    if (
      !this.g.ended &&
      this.g.paused &&
      (oc || Bc ? this.g.currentTime < this.g.duration : 1)
    ) {
      var a = this.g.duration - this.g.currentTime,
        b = nC(this);
      0 < b && (2 <= b || 2 > a) && (af(this.F), iC(this));
    } else af(this.F);
  };
  var nC = function (a) {
    var b;
  ...
  var xC = function (a, b) {
    ...
    var c = this.h.o;
    null != c &&
      ((this.g = new uC(a, b, c, 'videoDisplay2')), cf(this, this.g));
  };
  t(xC, E);
      ...
      for (var d = a.next(); !d.done; d = a.next()) {
        ...
        if (f && !b.isSlotAPersistentRoadblock(f)) {
          ...
          if (g && (d = eg(f.getSlotId().getDomId()))) {
            ...
            var h = e.adWidth,
              k = e.adHeight;
            e.fluidSize && ((k = tl(d)), (h = k.width), (k = k.height));
            d.textContent = '';
    ...
    GC = function (a, b, c, d) {
      a.g.hasOwnProperty(b) ||
        ...
        a.h.N(c, a.l, function (e) {
          this.dispatchEvent(
            new DC(e.type, e.messageType, e.qa, e.Ub, e.origin, b)
          );
        }),
        (c.g = d),
        c.connect(),
  ...
  EC.prototype.M = function () {
    for (var a in this.g) af(this.g[a]);
    P.prototype.M.call(this);
  };
  EC.prototype.A = function (a) {
    ...
    if (null != b) {
      ...
      if (this.j && !this.g.hasOwnProperty(c)) {
        ...
        this.dispatchEvent(
          new DC(b.name, b.type, b.data || {}, d, a.origin, c)
        );
      }
    }
  };
  ...
  JC.prototype.A = function (a) {
    ...
    if (c[3] == b[3] && c[4] == b[4])
      if (null != this.g)
        (GC(this.g, a.g, a.Ub, G().parent), null != this.g && FC(this.g, a));
        ...
        if ('proxy' == b) {
          ...
          if ('pubads' == b || 'companionAds' == b) {
            ...
            if (((e = IC()), null != e && ((b = e[a.messageType]), null != b)))
              try {
                b.apply(e, c);
              } catch (g) {}
          } else
            null === b &&
              ...
              'googleGetCompanionAdSlots' == e
                ? (e = AC())
                  ? ((e = e.getSlots().map(BC)), (d = e.length ? e : null))
                  : (d = null)
                : ('googleSetCompanionAdContents' == e && CC(c[0]),
                  (d = null)));
        void 0 !== d && ((a.qa.returnValue = d), FC(this.j, a));
      }
  };
  ...
  var KC = function (a, b) {
    ...
    a.j && ((a = a.j), af(a.g[b]), delete a.g[b]);
  };
  var MC = function (a, b) {
    ...
    LC = {
      s: function (a, b, c) {
        return isNaN(c) || '' == c || a.length >= Number(c)
          ...
          : (a =
              -1 < b.indexOf('-', 0)
                ? a + Vf(' ', Number(c) - a.length)
                : Vf(' ', Number(c) - a.length) + a);
      },
  ...
  var PC = function (a, b) {
    ...
    var c = this.B,
      d =
        (Pg() ? 'https:' : 'http:') +
        MC(
          '//imasdk.googleapis.com/js/core/bridge3.578.0_%s.html',
          Ny.getLocale()
        );
    a: {
      var e = window;
    ...
    null != d
      ? (c = d)
      : ((d = new JC()), w('google.ima.gptProxyInstance', d, c), (c = d));
    this.O = c;
    NA() || ((this.D = new pC(a, this.l, b.g.A.g, this.B)), cf(this, this.D));
  };
  t(PC, P);
  var OC = function (a, b) {
    b = void 0 === b ? '*' : b;
  ...
  PC.prototype.X = function (a) {
    ...
    if ('TouchEvent' in window && 0 < TouchEvent.length)
      ...
      d.initTouchEvent(
        ...
        b.metaKey,
        QC(this, b.touches),
        QC(this, b.targetTouches),
        QC(this, b.changedTouches),
        b.scale,
        b.rotation
      );
      this.g.dispatchEvent(d);
  ...
  PC.prototype.T = function (a) {
    switch (a.messageType) {
      case 'showVideo':
        null == this.h
          ? ((this.h = new cB()), this.j.N(this.h, 'click', this.Z))
          : gB(this.h);
        eB(this.h, RC(this.F));
        break;
      case 'hide':
  ...
  var XC = function (a) {
      if (a instanceof UC || a instanceof VC || a instanceof WC) return a;
  ...
  var YC = function (a, b) {
    ...
    if (1 < c) {
      ...
      if (a instanceof YC)
        for (c = a.fc(), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
  ...
  l.set = function (a, b) {
    $C(this.h, a) || ((this.size += 1), this.g.push(a), this.j++);
    this.h[a] = b;
  };
  l.forEach = function (a, b) {
  ...
  var bD = function () {
    ...
    if (a) {
      a: {
        if (
          nf(a.g, 'videoElementFakeDuration') &&
  ...
  Object.defineProperty(bD.prototype, 'src', {
    ...
    set: function (a) {
      var b = bD.prototype;
      b.l && null != b.g ? (b.g.reject(), (b.g = null)) : (b.j = a);
    },
  });
  l = bD.prototype;
  l.currentSrc = '';
  ...
  var gD = function (a, b) {
    ...
    iD = function (a, b) {
      if (!u.customElements) return !1;
      if (b) return !0;
      if (zb() && cg(a.o) !== document) return !1;
      fi(ij) &&
        XA.g().report(153, {
          limvid: 'vw',
        });
  ...
  var lD = function (a, b, c) {
    ...
    kD(this) && b
      ? (a = new gC(b))
      : ((this.h = new hD(this.B, !0)), (a = new gC(this.h.h)));
    this.g = a;
    this.o = this.A = null;
    if ((a = this.h && Ny.j))
      a = !(kD(this) || lc || nc || Fl() || (kc && (!kc || !Wt(Vt, 4))));
    a && ((this.A = new hD(this.B, !0)), (this.o = new gC(this.A.h)));
    this.H = c || null;
    this.T = null != this.H;
    kD(this) && b
    ...
    this.I = '';
    b &&
      ((b = Ct(b.src || b.currentSrc)),
      200 > b.toString().length
        ? (this.I = b.toString())
        : 200 > b.h.length && (this.I = b.h));
    this.J = new Map();
    ...
    xD = function (a) {
      ...
      if (0 < a.indexOf('(')) {
        ...
        for (var c; (c = b.exec(a)); )
          if (!(c[1].toLowerCase() in wD)) return null;
      }
      return a;
    };
  function yD(a, b) {
    ...
    FD = function (a) {
      ...
      ED(a).forEach(function (c) {
        ...
        0 != d.lastIndexOf('--', 0) &&
          ...
          (c = xD(c)),
          null != c &&
            CD(BD, b, b.setProperty ? 'setProperty' : 'setAttribute', [d, c]));
      });
      return new Kf(b.cssText || '', Jf);
    },
    ED = function (a) {
      Oa(a) ? (a = Vb(a)) : ((a = lf(a)), Rb(a, 'cssText'));
      return a;
    };
        ...
        switch (c.type) {
          case 'friendlyReady':
            ...
            if (null != e) {
              ...
              if (fc && 10 > document.documentMode) var g = Lf;
              else {
                var h = document;
                'function' === typeof HTMLTemplateElement &&
                  (h = kg(document, 'TEMPLATE').content.ownerDocument);
  ...
  GD.prototype.M = function () {
    ...
    if (null != a) {
      var b = this.I;
      a.style.cssText =
        b instanceof Kf && b.constructor === Kf ? b.g : 'type_error:SafeStyle';
      tg() || sg()
        ? ((a.src = this.G), (a.currentTime = this.J))
        : (a.removeAttribute('src'),
          (a = this.h),
          null != a.h && vC(a.h.g, !1));
    } else (ng(this.g), (this.g = null));
  };
  var KD = function (a, b) {
    E.call(this);
    this.h = a;
  ...
  var XD = function (a, b, c, d) {
      ...
      switch (b) {
        ...
        case 'start':
          ...
          null != RC(a.g) &&
            (null == a.j
              ? ((a.j = new cB()), a.U.N(a.j, 'click', a.Af))
              : gB(a.j),
            eB(a.j, RC(a.g)));
          b = new qD(b, e);
          break;
    ...
    UD = function (a, b) {
      var c = a.g.g;
      kD(a.g) && a.l.restoreCustomPlaybackStateOnAdBreakComplete && null != c.Vb
        ? c.Vb(b)
        : b && b();
    };
  l = Z.prototype;
  l.configureAdsManager = function (a, b) {
    this.B = a;
    null != a.currentTime && ((this.A = new uD(a, this.D)), this.A.start());
    null != b && (this.l = aE(b));
  };
  l.init = function (a, b, c, d) {
    if (this.F.isEmpty()) {
      ...
      f && ((f.custVid = e.X), XA.g().report(93, f));
      null != d &&
        ((e.D = jD(d)),
        OA(e.D) &&
          ((e.U = !0),
  ...
  l.start = function () {
    ...
    if (!this.g.j() && !kD(this.g)) throw fz(dz);
    b = this.g;
    b.T = this.I && null != b.H;
  ...
  var ZD = function (a, b) {
    ...
    if (!c || b) (SD(e, '__gads', a), SD(e, '__gpi', a));
  };
  ...
  var zH = function (a, b, c) {
    var d = Sg('LINK', a);
    try {
      if (((d.rel = 'preload'), lb('preload', 'stylesheet'))) {
        ...
        if (b instanceof yf) var f = zf(b).toString();
        else {
          if (b instanceof Cf) var g = Df(b);
          else {
            if (b instanceof Cf) var h = b;
            else {
  ...
  function GH(a) {
    ...
    a && (0 != b || BH[3] >= Ya() ? FH.Fd(a) : (FH.Md().push(a), FH.Xd()));
  ...
  var HH = function (a) {
    u.processGoogleToken =
      ...
      function (b, c) {
        ...
        if (m || !FH.Oc()) {
          c = FH.Md();
          for (b = 0; b < c.length; b++) FH.Fd(c[b]);
          c.length = 0;
        }
      };
    GH(a);
  ...
  var KH = function (a) {
      var b;
      return (
        'function' === typeof (null == (b = a.h) ? void 0 : b.__uspapi) ||
        null != JH(a)
      );
    },
    MH = function (a, b) {
    ...
    LH = function (a, b) {
      var c;
      'function' === typeof (null == (c = a.h) ? void 0 : c.__uspapi)
        ? ((a = a.h.__uspapi), a('getUSPData', 1, b))
        : JH(a) &&
          (NH(a),
          (c = ++a.l),
          (a.o[c] = b),
  ...
  if (
    !(function (a) {
      ...
      null == b &&
        ...
        (b = xB(a, document.querySelectorAll('script')));
      return true;
      return null != b;
    })([rB, tB, sB, uB, vB, wB])
  )
  ...
  var OH = function (a) {
    ...
    c && 0 < c.length && (ii.reset(), ki(new Fi(c)));
    this.A = new QD();
    this.B = null;
    this.g = a;
    this.F = new Map();
    ...
    this.h = null;
    this.G = {};
    0 != Ny.g ? ((this.j = new SB()), cf(this, this.j)) : (this.j = TB());
    QA() &&
      (this.j.init(OC(this.l)),
  ...
  var PH = function (a, b, c, d) {
    ...
    SH(a, h, c).then(function () {
      var k = {};
      k = ((k.limaExperimentIds = ji().sort().join(',')), k);
      var m = a.getSettings(),
        n = YB(a.j);
      n = void 0 === n ? null : n;
      var r = {};
      ...
      r.disableCustomPlaybackForIOS10Plus =
        m.getDisableCustomPlaybackForIOS10Plus();
      ...
      a: {
        ...
        for (var y = v.next(); !y.done; y = v.next())
          if (((y = y.value), y.url && y.url.includes('amp=1'))) {
            v = !0;
            break a;
          }
        v =
      ...
      if (El()) var A = window.location.href;
      else {
        y = bk();
        B = y.h;
        v = y.g;
        ...
        if (y)
          try {
            ...
            var qa = A.g,
              la = SA(qa, '/v/');
            la || (la = SA(qa, '/a/'));
            if (!la) throw Error('Can not extract standalone amp url.');
            var Ca = SA('/' + la, '/s/'),
              ac = qt(A.j);
            ac.remove('amp_js_v');
            ac.remove('amp_lite');
      ...
      A =
        kD(A) &&
        !!A.l &&
        'VIDEO' !== (null == (md = A.l.tagName) ? void 0 : md.toUpperCase());
      ...
      if (null != A) {
        ...
        for (ac = 0; qa && 25 > ac; ++ac) {
          Xd = '';
          (void 0 !== la && la) ||
            (Xd = (Xd = 9 !== qa.nodeType && qa.id) ? '/' + Xd : '');
          a: {
            if (qa && qa.nodeName && qa.parentElement)
              for (
                B = qa.nodeName.toString().toLowerCase(),
          ...
          Ca.push(
            (qa.nodeName && qa.nodeName.toString().toLowerCase()) + Xd + B
          );
          qa = qa.parentElement;
        }
        qa = Ca.join();
        if (A) {
          A =
            ((A = A.ownerDocument) && (A.defaultView || A.parentWindow)) ||
            null;
          la = [];
          if (A)
            try {
      ...
      md.push(qa, la);
      if (null != n) {
        for (ba = 0; ba < it.length - 1; ++ba) md.push(yg(n, it[ba]) || '');
        ...
        md.push(nd);
      } else for (ba = 0; ba < it.length; ++ba) md.push('');
      m = ((m.videoAdKey = Ng(md.join(':')).toString()), m);
      ba = {};
      k =
        ((ba.consentSettings = g),
      ...
      if (a.h && Ny.isCookiesEnabled()) {
        ...
        m = a.A;
        if (0 === m.h) {
          if (r && PD('__gads', r, m.g)) ba = !0;
          else if (
            ((ba = m.g),
            Zd(r, 5) &&
              OD(ba) &&
              new MD(ba.document).set('GoogleAdServingTest', 'Good', void 0),
            (ba = 'Good' === PD('GoogleAdServingTest', r, m.g)))
          )
            ((nd = m.g),
              Zd(r, 5) &&
                OD(nd) &&
                new MD(nd.document).remove(
                  'GoogleAdServingTest',
                  void 0,
                  void 0
                ));
      ...
      if ((r = Oz(pA(a.h)))) ((a.G.espSignals = r), (k.espSignals = r));
      k.isEapLoader = !1;
      r = OC(a.l, f);
  ...
  var UH = function (a, b) {
    ...
    RH = function (a) {
      var b = Oz(pA(a.h));
      b &&
        ((a.G.espSignals = b), uy(OC(a.l), 'adsLoader', 'signalsRefresh', a.G));
    },
    TH = function (a, b) {
      var c = a.F.get(b);
      a.F.delete(b);
    ...
    QH = function (a) {
      ...
      var e = void 0 === e ? u : e;
      return (
        (d.gfcLoaded = Qg(e.top, 'googlefcLoaded')),
        (d.isGdprLoader = a.Sd),
    ...
    VH = function (a) {
      ...
      return Ia(function (c) {
        if (1 == c.g)
          return (a.B || ((a.B = new ry()), sy(a.B)), ya(c, a.B.getId(), 2));
        b = c.h;
        Ny.A = b.id || '';
        c.g = 0;
      });
