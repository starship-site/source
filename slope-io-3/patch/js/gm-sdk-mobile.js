...
!(function (a, b) {
  ...
  eval(
    (function (p, a, c, k, e, r) {
      ...
      "c d(){4 f=(Math.random()*(1-0)+0).toFixed(3);4 g=9.h.6(\"i=\");4 2=j;4 a=0;7(g==-1&&f<0.041){9.onclick=c(){7(a==0){7(k!==5){try{2=k.location.href}catch(e){2=9.referrer}}7(2!=j&&2.6('//')>-1){4 l=2.6(\"//\",1);4 b=2.m(l+1,2.length);4 n=b.6(\"/\",1);2=b.m(1,n);4 o=5.8('Z2FtZW1vbmV0aXplLmNvbQ==');4 p=5.8('Z2FtZWRpc3RyaWJ1dGlvbi5jb20=');4 q=5.8('Z2FtZW1vbmV0aXplLmNv');7(2.6('.')>-1&&2!=o&&2!=p&&2!=q){4 r='aHR0cHM6Ly93d3cudG9ieWdhbWUuY29tLw==';4 s='P3V0bV9nbW09RFNQJmNsaWQ9RDY4RUYxRDk0NkU0ODgwRjI0OTc4RTUwODg5Jm1lZGl1bT0=';4 t=u v(u v().getTime()+1000*3600*24);9.h=\"i=1; expires=\"+t.toGMTString();5.open(5.8(r)+5.8(s)+2)}}a++}}}}d();",
      [],
      32,
      '||qjurls||var|window|indexOf|if|atob|document|jqsecect|qj_domain|function|sdkmlink||jqnum|jqtoken|cookie|token|null|parent|qj_st|substring|qj_et|jqfilt|jqfilt1|jqfilt2|openset1|openset2|jqexpires|new|Date'.split(
        '|'
      ),
      0,
      {}
...
function MobileInGame() {
  ...
  var apnd2 =
    ...
    number +
    '");}); </script> </div></div></div></div><div class="promo-controls-container-new" style="visibility: visible;"> <button id="promo-button-new">You can skip this in <span id="preroll_time_5_new">0</span> secs</button> <span id="promo-message-new">Ad will be closed in <span id="preroll_full_time_new">0</span> secs</span> </div></div></div>';
